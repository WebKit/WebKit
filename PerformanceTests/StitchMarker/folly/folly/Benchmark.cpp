...
static constexpr int64_t FLAGS_bm_min_usec = 100;
static constexpr int32_t FLAGS_bm_min_iters = 1;
static constexpr int64_t FLAGS_bm_max_iters = 1 << 30;
static constexpr int32_t FLAGS_bm_max_secs = 1;
