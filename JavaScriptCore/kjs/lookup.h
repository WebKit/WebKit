...
#define JSC_DEFINE_PROTOTYPE(ClassPrototype) \
  ...
  public: \
    ...
    ClassPrototype(JSC::ExecState* exec) \
...
#define JSC_DEFINE_PROTOTYPE_WITH_PROTOTYPE(ClassPrototype, ClassPrototypePrototype) \
    ...
    public: \
        ...
        bool getOwnPropertySlot(JSC::ExecState*, const JSC::Identifier&, JSC::PropertySlot&); \
        ClassPrototype(JSC::ExecState* exec) \
            : JSC::JSObject(ClassPrototypePrototype::self(exec)) { } \
    \
    };
...
#define JSC_IMPLEMENT_PROTOTYPE(ClassName, ClassPrototype) \
    ...
    { \
        return JSC::cacheGlobalObject<ClassPrototype>(exec, Identifier(exec, "[[" ClassName ".prototype]]")); \
    } \
