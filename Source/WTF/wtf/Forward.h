...
enum class ShouldValidateKey : bool { Yes, No };
template<typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, ShouldValidateKey validateKey = ShouldValidateKey::Yes> class HashTable;
...
using UnsafeHashMap = HashMap<KeyArg, MappedArg, KeyHash, KeyTraits, MappedTraits, HashTraits, ShouldValidateKey::No>;
