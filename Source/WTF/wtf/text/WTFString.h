...
public:
    ...
    static String adopt(Vector<CharacterType, inlineCapacity, OverflowHandler, minCapacity, WTF::StringImplMalloc>&& vector) { return StringImpl::adopt(WTFMove(vector)); }
