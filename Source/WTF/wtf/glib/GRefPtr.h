...
WTF_DEFINE_GREF_TRAITS_INLINE(GKeyFile, g_key_file_ref, g_key_file_unref)
...
WTF_DEFINE_GREF_TRAITS_INLINE(GStrvBuilder, g_strv_builder_ref, g_strv_builder_unref)
