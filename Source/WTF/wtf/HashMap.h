...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
class HashMap final {
...
public:
    ...
    // // Conversion constructor for upgrading from ShouldValidateKey::No to ShouldValidateKey::Yes
    // template <ShouldValidateKey OtherValidateKey,
    //           typename = std::enable_if_t<OtherValidateKey == ShouldValidateKey::No>>
    // HashMap(const HashMap<KeyArg, MappedArg, HashArg, KeyTraits, MappedTraits, HashTableTraits, OtherValidateKey>& other)
    //     : m_impl(other.m_impl) {}

    template <ShouldValidateKey OtherValidateKey,
              typename = std::enable_if_t<OtherValidateKey != validateKey>>
    explicit HashMap(const HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, OtherValidateKey>& other)
        : m_impl(other.m_impl) {}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline void HashMap<T, U, V, W, X, Y, validateKey>::swap(HashMap& other)
{
    m_impl.swap(other.m_impl);
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline unsigned HashMap<T, U, V, W, X, Y, validateKey>::size() const
{
    return m_impl.size(); 
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline unsigned HashMap<T, U, V, W, X, Y, validateKey>::capacity() const
{ 
    return m_impl.capacity(); 
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline size_t HashMap<T, U, V, W, X, Y, validateKey>::byteSize() const
{
    return m_impl.byteSize();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::isEmpty() const
{
    return m_impl.isEmpty();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::begin() -> iterator
{
    return m_impl.begin();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::end() -> iterator
{
    return m_impl.end();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::begin() const -> const_iterator
{
    return m_impl.begin();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::end() const -> const_iterator
{
    return m_impl.end();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(const KeyType& key) -> iterator
{
    return m_impl.find(key);
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(const KeyType& key) const -> const_iterator
{
    return m_impl.find(key);
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::contains(const KeyType& key) const
{
...
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(const TYPE& value) -> iterator
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename HashTranslator, typename TYPE>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(const TYPE& value) const -> const_iterator
{
    return m_impl.template find<HashMapTranslatorAdapter<KeyValuePairTraits, HashTranslator>>(value);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename HashTranslator, typename TYPE>
auto HashMap<T, U, V, W, X, Y, validateKey>::get(const TYPE& value) const -> MappedPeekType
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename HashTranslator, typename TYPE>
auto HashMap<T, U, V, W, X, Y, validateKey>::inlineGet(const TYPE& value) const -> MappedPeekType
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename HashTranslator, typename TYPE>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::contains(const TYPE& value) const
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename HashTranslator, typename TYPE>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::remove(const TYPE& value)
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename K, typename V>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::inlineSet(K&& key, V&& value) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename K, typename V>
ALWAYS_INLINE auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::inlineAdd(K&& key, V&& value) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename K>
ALWAYS_INLINE auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::inlineEnsure(K&& key, const Invocable<MappedType()> auto& functor) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename T>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::set(const KeyType& key, T&& mapped) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename T>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::set(KeyType&& key, T&& mapped) -> AddResult
{
...
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::ensure(K&& key, const Invocable<MappedType()> auto& functor) -> AddResult
{
...
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::add(K&& key, V&& value) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename T>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::add(const KeyType& key, T&& mapped) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename T>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::add(KeyType&& key, T&& mapped) -> AddResult
{
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename T>
ALWAYS_INLINE auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::fastAdd(const KeyType& key, T&& mapped) -> AddResult
{
    return inlineAdd(key, std::forward<T>(mapped));
}
...
template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
template<typename T>
ALWAYS_INLINE auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::fastAdd(KeyType&& key, T&& mapped) -> AddResult
{
    return inlineAdd(WTFMove(key), std::forward<T>(mapped));
}

template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::ensure(const KeyType& key, const Invocable<MappedType()> auto& functor) -> AddResult
{
    return inlineEnsure(key, functor);
}

template<typename KeyArg, typename MappedArg, typename HashArg, typename KeyTraitsArg, typename MappedTraitsArg, typename TableTraitsArg, ShouldValidateKey validateKey>
auto HashMap<KeyArg, MappedArg, HashArg, KeyTraitsArg, MappedTraitsArg, TableTraitsArg, validateKey>::ensure(KeyType&& key, const Invocable<MappedType()> auto& functor) -> AddResult
{
    return inlineEnsure(std::forward<KeyType>(key), functor);
}
    
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::get(const KeyType& key) const -> MappedPeekType
{
    return get<IdentityTranslatorType>(key);
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::getOptional(const KeyType& key) const -> std::optional<MappedType>
{
...
template<typename T, typename U, typename V, typename W, typename MappedTraits, typename Y, ShouldValidateKey validateKey>
ALWAYS_INLINE auto HashMap<T, U, V, W, MappedTraits, Y, validateKey>::inlineGet(const KeyType& key) const -> MappedPeekType
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::remove(iterator it)
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::removeIf(const Invocable<bool(KeyValuePairType&)> auto& functor)
{
    return m_impl.removeIf(functor);
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::remove(const KeyType& key)
{
    return remove(find(key));
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline void HashMap<T, U, V, W, X, Y, validateKey>::clear()
{
    m_impl.clear();
}

template<typename T, typename U, typename V, typename W, typename MappedTraits, typename Y, ShouldValidateKey validateKey>
auto HashMap<T, U, V, W, MappedTraits, Y, validateKey>::take(const KeyType& key) -> MappedTakeType
{
    return take(find(key));
}

template<typename T, typename U, typename V, typename W, typename MappedTraits, typename Y, ShouldValidateKey validateKey>
auto HashMap<T, U, V, W, MappedTraits, Y, validateKey>::take(iterator it) -> MappedTakeType
{
    if (it == end())
...
template<typename T, typename U, typename V, typename W, typename MappedTraits, typename Y, ShouldValidateKey validateKey>
auto HashMap<T, U, V, W, MappedTraits, Y, validateKey>::takeOptional(const KeyType& key) -> std::optional<MappedTakeType>
{
    auto it = find(key);
    if (it == end())
        return std::nullopt;
...
template<typename T, typename U, typename V, typename W, typename MappedTraits, typename Y, ShouldValidateKey validateKey>
auto HashMap<T, U, V, W, MappedTraits, Y, validateKey>::takeFirst() -> MappedTakeType
{
    return take(begin());
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) -> typename std::enable_if<IsSmartPtr<K>::value, iterator>::type
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) const -> typename std::enable_if<IsSmartPtr<K>::value, const_iterator>::type
{
    return m_impl.template find<HashMapTranslator<KeyValuePairTraits, HashFunctions>>(key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::contains(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) const -> typename std::enable_if<IsSmartPtr<K>::value, bool>::type
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::inlineGet(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) const -> typename std::enable_if<IsSmartPtr<K>::value, MappedPeekType>::type
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
auto HashMap<T, U, V, W, X, Y, validateKey>::get(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) const -> typename std::enable_if<IsSmartPtr<K>::value, MappedPeekType>::type
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::remove(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) -> typename std::enable_if<IsSmartPtr<K>::value, bool>::type
{
    return remove(find(key));
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::take(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>* key) -> typename std::enable_if<IsSmartPtr<K>::value, MappedTakeType>::type
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, iterator>::type
{
    return find(&key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::find(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) const -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, const_iterator>::type
{
    return find(&key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::contains(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) const -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, bool>::type
{
    return contains(&key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::inlineGet(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) const -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, MappedPeekType>::type
{
    return inlineGet(&key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
auto HashMap<T, U, V, W, X, Y, validateKey>::get(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) const -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, MappedPeekType>::type
{
    return inlineGet(&key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::remove(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, bool>::type
{
    return remove(&key);
}
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
template<typename K>
inline auto HashMap<T, U, V, W, X, Y, validateKey>::take(std::add_const_t<typename GetPtrHelper<K>::UnderlyingType>& key) -> typename std::enable_if<IsSmartPtr<K>::value && !IsSmartPtr<K>::isNullable, MappedTakeType>::type
{
    return take(&key);
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline void HashMap<T, U, V, W, X, Y, validateKey>::checkConsistency() const
{
    m_impl.checkTableConsistency();
}

template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
inline bool HashMap<T, U, V, W, X, Y, validateKey>::isValidKey(const KeyType& key)
{
...
template<typename T, typename U, typename V, typename W, typename X, typename Y, ShouldValidateKey validateKey>
bool operator==(const HashMap<T, U, V, W, X, Y, validateKey>& a, const HashMap<T, U, V, W, X, Y, validateKey>& b)
{
    if (a.size() != b.size())
        return false;

    typedef typename HashMap<T, U, V, W, X, Y, validateKey>::const_iterator const_iterator;
