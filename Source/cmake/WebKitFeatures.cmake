...
macro(WEBKIT_OPTION_BEGIN)
    ...
    if (APPLE AND (WTF_CPU_ARM64 OR WTF_CPU_X86_64) AND NOT USE_MIMALLOC_DEFAULT AND NOT USE_SYSTEM_MALLOC_DEFAULT)
        set(USE_TZONE_MALLOC_DEFAULT ON)
    else ()
        set(USE_TZONE_MALLOC_DEFAULT OFF)
    endif ()
    ...
    WEBKIT_OPTION_DEFINE(USE_TZONE_MALLOC "Toggle TZoneMalloc support" PRIVATE ${USE_TZONE_MALLOC_DEFAULT})
    ...
    WEBKIT_OPTION_CONFLICT(USE_TZONE_MALLOC USE_MIMALLOC)
    WEBKIT_OPTION_CONFLICT(USE_TZONE_MALLOC USE_SYSTEM_MALLOC)
