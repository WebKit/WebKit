...
macro(WEBKIT_OPTION_BEGIN)
    ...
    if (DEVELOPER_MODE)
        set(ENABLE_CRASH_DUMP_INFO_DEFAULT OFF)
    else ()
        set(ENABLE_CRASH_DUMP_INFO_DEFAULT ON)
    endif ()
    ...
    WEBKIT_OPTION_DEFINE(ENABLE_CRASH_DUMP_INFO "Enables extra crash investigation tools that might increase binary size." PRIVATE ${ENABLE_CRASH_DUMP_INFO_DEFAULT})
