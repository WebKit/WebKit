...
macro(WEBKIT_OPTION_DEFINE _name _description _initial_value)
...
macro(WEBKIT_OPTION_DEFINE_PUBLIC _name _description _initial_value)
    WEBKIT_OPTION_DEFINE(${_name} ${_description} ${_initial_value})
    set(_WEBKIT_AVAILABLE_OPTIONS_IS_PUBLIC_${_name} TRUE)
endmacro()
...
macro(WEBKIT_OPTION_BEGIN)
    ...
    WEBKIT_OPTION_DEFINE(ENABLE_STREAMS_API "Toggle Streams API support" ON)
