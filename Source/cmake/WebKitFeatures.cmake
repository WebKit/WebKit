...
macro(WEBKIT_OPTION_BEGIN)
    ...
    # A machine without liblldb still supports mya, but mya_heap gets turned off.
    if (NOT DEFINED ENABLE_MYA_HEAP_DEFAULT)
        ...
        if (ENABLE_MYA_DEFAULT AND CMAKE_BUILD_TYPE STREQUAL "Debug")
            ...
            if (LLDB_FOUND)
                ...
                message(STATUS "liblldb not found, mya_heap is off. "
                    "Install liblldb-dev (Debian, Ubuntu), lldb-devel (Fedora) or llvm (Homebrew) "
                    "or set LLDB_ROOT to enable mya_heap.")
            endif ()
        endif ()
    endif ()
    ...
    WEBKIT_OPTION_DEFINE(ENABLE_MYA "Toggle the mya MemorY Analyzer tool." PRIVATE ${ENABLE_MYA_DEFAULT})
    WEBKIT_OPTION_DEFINE(ENABLE_MYA_HEAP "Include additional debug info in the build to support mya heap analysis features." PRIVATE ${ENABLE_MYA_HEAP_DEFAULT})
