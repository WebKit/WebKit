...
if (${ENABLE_EXPERIMENTAL_FEATURES} AND "${WPE_VERSION}" VERSION_GREATER_EQUAL "1.13.0")
...
if (ENABLE_GAMEPAD AND (NOT ("${WPE_VERSION}" VERSION_GREATER_EQUAL "1.13.0")))
    message(FATAL_ERROR "libwpe>=1.13 is required for ENABLE_GAMEPAD")
endif ()
