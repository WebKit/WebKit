...
find_package(PNG 1.5.0 REQUIRED)
...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_WEB_AUTHN PRIVATE ${ENABLE_EXPERIMENTAL_FEATURES})
...
WEBKIT_OPTION_DEFINE(USE_TEXTURE_MAPPER "Whether to use TextureMapper for compositing instead of Skia" PRIVATE OFF)
...
if (ENABLE_WPE_1_1_API)
    if (NOT ENABLE_WPE_LEGACY_API)
        message(FATAL_ERROR "ENABLE_WPE_1_1_API requires ENABLE_WPE_LEGACY_API")
    endif ()
    if (ENABLE_WPE_QT_API)
        set(ENABLE_WPE_QT_API OFF)
        message(STATUS "Disabling ENABLE_WPE_QT_API since it requires the WPE 2.0 API.")
    endif ()
endif ()
...
# The WPE Platform is part of the 2.0 API; only the 1.1 API builds without it.
if (ENABLE_WPE_1_1_API)
    ...
    SET_AND_EXPOSE_TO_BUILD(ENABLE_WPE_PLATFORM ON)
endif ()
...
if (WPE_API_VERSION VERSION_EQUAL "1.1")
    ...
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 13 0 12)
endif ()
...
if (ENABLE_WPE_PLATFORM)
    ...
    if (ENABLE_GAMEPAD)
        ...
        if (Manette_FOUND)
            ...
            if (Manette_VERSION VERSION_GREATER_EQUAL "1.0.0")
                SET_AND_EXPOSE_TO_BUILD(HAVE_MANETTE_NORMALIZED_RUMBLE TRUE)
            endif ()
        endif ()
    endif ()
else ()
...
# soup_message_set_compression_dictionary_id() is new in 3.7.3.
if (Soup3_VERSION VERSION_GREATER_EQUAL 3.7.3)
    SET_AND_EXPOSE_TO_BUILD(HAVE_SOUP_COMPRESSION_DICTIONARY_SUPPORT TRUE)
else ()
    SET_AND_EXPOSE_TO_BUILD(HAVE_SOUP_COMPRESSION_DICTIONARY_SUPPORT FALSE)
endif ()
