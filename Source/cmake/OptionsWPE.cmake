...
WEBKIT_OPTION_DEFINE(USE_OPENSSL_BACKEND "Whether to use the OpenSSL crypto backend instead of libgcrypt" PRIVATE OFF)
...
if (WPE_API_VERSION VERSION_EQUAL "1.1")
    ...
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 7 0 6)
endif ()
...
if (USE_OPENSSL_BACKEND)
    ...
    SET_AND_EXPOSE_TO_BUILD(USE_OPENSSL TRUE)
else ()
