...
install:
    ...
    -xcopy "%ConfigurationBuildDir%\bin32\JavaScriptCore.dll" "%ProgramFilesAAS%" /e/v/i/h/y
    -xcopy "%ConfigurationBuildDir%\bin32\JavaScriptCore_debug.dll" "%ProgramFilesAAS%" /e/v/i/h/y
    -xcopy "%ConfigurationBuildDir%\bin32\JavaScriptCore.pdb" "%ProgramFilesAAS%" /e/v/i/h/y
    -xcopy "%ConfigurationBuildDir%\bin32\JavaScriptCore_debug.pdb" "%ProgramFilesAAS%" /e/v/i/h/y
    ...
    xcopy "%ConfigurationBuildDir%\bin32\JavaScriptCore.resources\*" "%ProgramFilesAAS%\JavaScriptCore.resources" /e/v/i/h/y
