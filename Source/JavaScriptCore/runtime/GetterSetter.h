...
public:
    ...
    bool isGetterNull() const { return !!dynamicDowncast<NullGetterFunction>(m_getter.get()); }
    bool isSetterNull() const { return !!dynamicDowncast<NullSetterFunction>(m_setter.get()); }
