...
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    JSGlobalObject* globalObject = temporalObject->realm();
    return TemporalCalendarConstructor::create(vm, TemporalCalendarConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalCalendarPrototype*>(globalObject->calendarStructure()->storedPrototypeObject()));
}
...
static JSValue createDurationConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    JSGlobalObject* globalObject = temporalObject->realm();
    return TemporalDurationConstructor::create(vm, TemporalDurationConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalDurationPrototype*>(globalObject->durationStructure()->storedPrototypeObject()));
}
...
static JSValue createInstantConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    JSGlobalObject* globalObject = temporalObject->realm();
    return TemporalInstantConstructor::create(vm, TemporalInstantConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalInstantPrototype*>(globalObject->instantStructure()->storedPrototypeObject()));
}
...
static JSValue createPlainDateConstructor(VM& vm, JSObject* object)
{
    ...
    return TemporalPlainDateConstructor::create(vm, TemporalPlainDateConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalPlainDatePrototype*>(globalObject->plainDateStructure()->storedPrototypeObject()));
}
...
static JSValue createPlainDateTimeConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    auto* globalObject = temporalObject->realm();
    return TemporalPlainDateTimeConstructor::create(vm, TemporalPlainDateTimeConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalPlainDateTimePrototype*>(globalObject->plainDateTimeStructure()->storedPrototypeObject()));
}
...
static JSValue createPlainMonthDayConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    auto* globalObject = temporalObject->realm();
    return TemporalPlainMonthDayConstructor::create(vm, TemporalPlainMonthDayConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalPlainMonthDayPrototype*>(globalObject->plainMonthDayStructure()->storedPrototypeObject()));
}
...
static JSValue createPlainTimeConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    auto* globalObject = temporalObject->realm();
    return TemporalPlainTimeConstructor::create(vm, TemporalPlainTimeConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalPlainTimePrototype*>(globalObject->plainTimeStructure()->storedPrototypeObject()));
}
...
static JSValue createPlainYearMonthConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    auto* globalObject = temporalObject->realm();
    return TemporalPlainYearMonthConstructor::create(vm, TemporalPlainYearMonthConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalPlainYearMonthPrototype*>(globalObject->plainYearMonthStructure()->storedPrototypeObject()));
}
...
static JSValue createTimeZoneConstructor(VM& vm, JSObject* object)
{
    TemporalObject* temporalObject = jsUncheckedDowncast<TemporalObject*>(object);
    JSGlobalObject* globalObject = temporalObject->realm();
    return TemporalTimeZoneConstructor::create(vm, TemporalTimeZoneConstructor::createStructure(vm, globalObject, globalObject->functionPrototype()), jsUncheckedDowncast<TemporalTimeZonePrototype*>(globalObject->timeZoneStructure()->storedPrototypeObject()));
}
