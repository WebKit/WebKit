...
{
    RegExpObject* thisObject = jsUncheckedDowncast<RegExpObject*>(cell);
...
bool RegExpObject::getOwnPropertySlot(JSObject* object, JSGlobalObject* globalObject, PropertyName propertyName, PropertySlot& slot)
{
    ...
    if (propertyName == vm.propertyNames->lastIndex) {
        RegExpObject* regExp = jsUncheckedDowncast<RegExpObject*>(object);
...
{
    return jsUncheckedDowncast<RegExpObject*>(JSValue::decode(thisValue))->setLastIndex(globalObject, JSValue::decode(value), true);
}
...
{
    return jsUncheckedDowncast<RegExpObject*>(JSValue::decode(thisValue))->setLastIndex(globalObject, JSValue::decode(value), false);
}
