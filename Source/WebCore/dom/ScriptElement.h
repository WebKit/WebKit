...
protected:
    ...
    void setChangedByTrustedSink(bool changedByTrustedSink) { m_changedByTrustedSink = changedByTrustedSink; }
...
private:
    ...
    bool m_changedByTrustedSink : 1 { false };
    bool m_isTrusted : 1 { true };
