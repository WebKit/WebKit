...
public:
    ...
    bool styleOfSiblingsAffectedByEmpty() const { return hasRareData() && rareDataStyleOfSiblingsAffectedByEmpty(); }
    ...
    void setStyleOfSiblingsAffectedByEmpty();
...
private:
    ...
    bool rareDataStyleOfSiblingsAffectedByEmpty() const;
