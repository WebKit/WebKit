...
using ExplicitlySetAttrElementsMap = UnsafeHashMap<QualifiedName, Vector<WeakPtr<Element, WeakPtrImplWithEventTargetData>>>;
...
public:
    ...
    virtual Attribute replaceURLsInAttributeValue(const Attribute&, const UnsafeHashMap<String, String>&) const;
