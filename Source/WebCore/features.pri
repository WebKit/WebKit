...
!contains(DEFINES, ENABLE_SPELLCHECK_API=.): DEFINES += ENABLE_SPELLCHECK_API=1
...
contains(DEFINES, ENABLE_SPELLCHECK_API=1): FEATURE_DEFINES_JAVASCRIPT += ENABLE_SPELLCHECK_API=1
