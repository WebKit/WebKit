...
cssbison.commands = perl $$cssbison.script --grammar ${QMAKE_FILE_NAME} --outputDir ${QMAKE_FUNC_FILE_OUT_PATH} --extraDefines \"$${DEFINES} $$configDefines()\" --symbolsPrefix cssyy
