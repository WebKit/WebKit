...
public:
    ...
    LayoutSize imageSizeForRenderer(const RenderElement*, float multiplier = 1.0f, ImageSizeType = ImageSizeType::Used, float density = 1.0f) const;
    ...
    LayoutSize unclampedImageSizeForRenderer(const RenderElement*, float multiplier = 1.0f, ImageSizeType = ImageSizeType::Used, float density = 1.0f) const;
    ...
    WEBCORE_EXPORT FloatSize imageFloatSizeForRenderer(const RenderElement*, float multiplier = 1.0f, ImageSizeType = ImageSizeType::Used, float density = 1.0f) const;
...
private:
    ...
    using ContainerContextRequests = HashMap<SingleThreadWeakPtr<const ImageContainerContextKey>, ImageContainerContext>;
