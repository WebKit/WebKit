...
private:
    using CachedResourceMap = UnsafeHashMap<std::pair<URL, String /* partitionName */>, WeakPtr<CachedResource>>;
    ...
    typedef UnsafeHashMap<PAL::SessionID, std::unique_ptr<CachedResourceMap>> SessionCachedResourceMap;
