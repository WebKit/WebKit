...
private:
    UnsafeHashMap<FormElementKey, Deque<FormControlState>> m_map;
};
...
private:
    ...
    UnsafeHashMap<String, unsigned> m_formSignatureToNextIndexMap;
};
...
{
    UnsafeHashMap<AtomString, Vector<Ref<const ValidatedFormListedElement>>> formKeyToControlsMap;
