...
std::optional<std::variant<Ref<RadioNodeList>, Ref<Element>>> HTMLFormControlsCollection::namedItemOrItems(const AtomString& name) const
{
    ...
    return { ownerNode().radioNodeList(name) };
}
