...
public:
    ...
    typedef UnsafeHashMap<AtomString, std::unique_ptr<RuleDataVector>> AtomRuleMap;
...
private:
    ...
    UnsafeHashMap<Vector<size_t>, Ref<const RuleSet>> m_mediaQueryInvalidationRuleSetCache;
