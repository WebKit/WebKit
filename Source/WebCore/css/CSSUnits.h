...
enum class CSSUnitType : uint8_t {
    ...
    ViewportPercentageWidth,
    ViewportPercentageHeight,
    ViewportPercentageMin,
    ViewportPercentageMax,
    ViewportPercentageBlockSize,
    ViewportPercentageInlineSize,
    SmallViewportWidth,
    SmallViewportHeight,
    SmallViewportMin,
    SmallViewportMax,
    SmallViewportBlockSize,
    SmallViewportInlineSize,
    LargeViewportWidth,
    LargeViewportHeight,
    LargeViewportMin,
    LargeViewportMax,
    LargeViewportBlockSize,
    LargeViewportInlineSize,
    DynamicViewportWidth,
    DynamicViewportHeight,
    DynamicViewportMin,
    DynamicViewportMax,
    DynamicViewportBlockSize,
    DynamicViewportInlineSize,
    FirstViewportCSSUnitType = ViewportPercentageWidth,
    LastViewportCSSUnitType = DynamicViewportInlineSize,

    ContainerQueryWidth,
    ContainerQueryHeight,
    ContainerQueryInlineSize,
    ContainerQueryBlockSize,
    ContainerQueryMin,
    ContainerQueryMax,
