...
WrapperMap::WrapperMap()
    : m_wrappers {
        ...
        new DiscreteWrapper(CSSPropertyID::CSSPropertyTestCustonmExtractor, &RenderStyle::testCustonmExtractor, &RenderStyle::setTestCustonmExtractor), // CSSPropertyID::CSSPropertyTestCustonmExtractor
