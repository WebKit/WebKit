...
WrapperMap::WrapperMap()
    : m_wrappers {
        ...
        new DiscreteWrapper(CSSPropertyID::CSSPropertyTestUnderline, &RenderStyle::testUnderline, &RenderStyle::setTestUnderline), // CSSPropertyID::CSSPropertyTestUnderline
