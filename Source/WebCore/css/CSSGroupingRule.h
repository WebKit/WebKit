...
protected:
    ...
    void appendCSSTextWithReplacementURLsForItems(StringBuilder&, const UnsafeHashMap<String, String>&, const UnsafeHashMap<RefPtr<CSSStyleSheet>, String>&) const;
...
private:
    ...
    void cssTextForRulesWithReplacementURLs(StringBuilder&, const UnsafeHashMap<String, String>&, const UnsafeHashMap<RefPtr<CSSStyleSheet>, String>&) const;
