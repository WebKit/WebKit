...
String CSSStyleSheet::cssTextWithReplacementURLs(const UnsafeHashMap<String, String>& replacementURLStrings, const UnsafeHashMap<RefPtr<CSSStyleSheet>, String>& replacementURLStringsForCSSStyleSheet)
{
