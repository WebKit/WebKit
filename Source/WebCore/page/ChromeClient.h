...
public:
    ...
    virtual void updateViewportConstrainedLayers(UnsafeHashMap<PlatformLayer*, std::unique_ptr<ViewportConstraints>>&, const UnsafeHashMap<PlatformLayer*, PlatformLayer*>&) { }
