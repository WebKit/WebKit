...
public:
    ...
    virtual RefPtr<ImageBuffer> createImageBuffer(const FloatSize&, RenderingMode, RenderingPurpose, float, const DestinationColorSpace&, ImageBufferPixelFormat, const ImageBufferCreationContext&) const { return nullptr; }
