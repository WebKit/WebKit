...
Page::Page(PageConfiguration&& pageConfiguration)
    ...
    , m_mainFrame(Frame::create(this, nullptr, WTFMove(pageConfiguration.loaderClientForMainFrame), pageConfiguration.mainFrameIdentifier ? *pageConfiguration.mainFrameIdentifier : FrameIdentifier::generate(), WTFMove(pageConfiguration.topDocumentSecurityOriginData)))
