...
bool RenderBlockFlow::willCreateColumns(std::optional<unsigned> desiredColumnCount) const
{
    ...
    // FIXME: Non-auto column-count should initiate MultiColumnFlow, but this breaks content because we can't handle nested multicol correctly. See bug 299836 and related.
