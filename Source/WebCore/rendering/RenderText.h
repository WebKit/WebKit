...
public:
    ...
    virtual LayoutUnit marginLeft() const FINAL { return minimumValueForLength(style()->marginLeft(), 0, view()); }
    virtual LayoutUnit marginRight() const FINAL { return minimumValueForLength(style()->marginRight(), 0, view()); }
    ...
    virtual unsigned renderedTextLength() const FINAL;
