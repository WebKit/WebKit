...
inline ItemDirection RenderStyle::itemDirection() const { return m_nonInheritedData->rareData->grid->m_itemDirection; }
...
constexpr ItemDirection RenderStyle::initialItemDirection() { return ItemDirection::Auto; }
