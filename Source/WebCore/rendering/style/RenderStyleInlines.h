...
inline const Vector<Style::GridTrackSize>& RenderStyle::gridAutoListForDirection(GridTrackSizingDirection direction) const { return direction == GridTrackSizingDirection::Columns ? gridAutoColumns() : gridAutoRows(); }
...
inline const Style::GridTemplateList& RenderStyle::gridTemplateListForDirection(GridTrackSizingDirection direction) const { return direction == GridTrackSizingDirection::Columns ? gridTemplateColumns() : gridTemplateRows(); }
