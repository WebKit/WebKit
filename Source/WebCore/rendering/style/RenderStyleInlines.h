...
constexpr Style::LineWidth RenderStyle::initialTextStrokeWidth() { return 0_css_px; }
...
inline float RenderStyle::outlineSize() const { return outline().size(); }
...
inline Style::LineWidth RenderStyle::textStrokeWidth() const { return m_rareInheritedData->textStrokeWidth; }
