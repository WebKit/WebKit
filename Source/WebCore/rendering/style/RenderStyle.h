...
public:
    ...
    inline float outlineSize() const;
    ...
    inline Style::LineWidth textStrokeWidth() const;
    ...
    inline void setTextStrokeWidth(Style::LineWidth);
    ...
    static constexpr Style::LineWidth initialTextStrokeWidth();
