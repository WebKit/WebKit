...
public:
    ...
    inline const Style::GridTemplateList& gridTemplateListForDirection(GridTrackSizingDirection) const;
    ...
    inline const Vector<Style::GridTrackSize>& gridAutoListForDirection(GridTrackSizingDirection) const;
