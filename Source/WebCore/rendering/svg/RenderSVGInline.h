...
private:
    ...
    // https://w3c.github.io/svgwg/svg2-draft/coords.html#BoundingBoxes. This is not the box that
    // 'objectBoundingBox' units resolve against: see SVGRenderSupport::objectBoundingBoxForResources().
    // The stroke, repaint and decorated boxes below still report the whole 'text' element, because
    // they drive invalidation and filter regions.
