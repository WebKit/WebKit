...
RenderStyle RenderLayer::createReflectionStyle()
{
    ...
    case ReflectionDirection::Below:
        transform.append(TranslateTransformOperation::create(Length(0, LengthType::Fixed), Length(100., LengthType::Percent), TransformOperation::Type::Translate));
        transform.append(TranslateTransformOperation::create(Length(0, LengthType::Fixed), renderer().style().boxReflect()->offset(), TransformOperation::Type::Translate));
        transform.append(ScaleTransformOperation::create(1.0, -1.0, ScaleTransformOperation::Type::Scale));
        break;
    ...
    case ReflectionDirection::Right:
        transform.append(TranslateTransformOperation::create(Length(100., LengthType::Percent), Length(0, LengthType::Fixed), TransformOperation::Type::Translate));
        transform.append(TranslateTransformOperation::create(renderer().style().boxReflect()->offset(), Length(0, LengthType::Fixed), TransformOperation::Type::Translate));
        transform.append(ScaleTransformOperation::create(-1.0, 1.0, ScaleTransformOperation::Type::Scale));
        break;
