...
class BoxModelPainter {
public:
    BoxModelPainter(const RenderBoxModelObject&, const PaintInfo&);
...
private:
    ...
    void paintOneBorderSide(const RenderStyle&, const RoundedRect& outerBorder, const RoundedRect& innerBorder,
        const LayoutRect& sideRect, BoxSide, BoxSide adjacentSide1, BoxSide adjacentSide2, const BorderEdges&, const Path*, BackgroundBleedAvoidance, bool includeLogicalLeftEdge, bool includeLogicalRightEdge, bool antialias, const Color* overrideColor = nullptr);
