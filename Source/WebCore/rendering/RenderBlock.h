...
public:
    ...
    LayoutRect NODELETE logicalRectToPhysicalRect(const LayoutPoint& physicalPosition, const LayoutRect& logicalRect);
...
private:
    ...
    const Style::ComputedStyle& NODELETE outlineStyleForRepaint() const LIFETIME_BOUND final;
