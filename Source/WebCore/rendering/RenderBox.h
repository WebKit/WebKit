...
private:
    ...
    void computeAnchorCenteredPosition(LogicalExtentComputedValues&, CheckedPtr<RenderBoxModelObject> defaultAnchorBox, Length logicalLeftLength, Length logicalRightLength, LayoutUnit containerLogicalWidth, bool computeHorizontally) const;
