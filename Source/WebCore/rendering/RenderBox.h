...
public:
    ...
    virtual LayoutUnit marginLogicalLeft() const FINAL { return m_marginBox.logicalLeft(style()->writingMode()); }
    virtual LayoutUnit marginLogicalRight() const FINAL { return m_marginBox.logicalRight(style()->writingMode()); }
    ...
    virtual bool hasViewportPercentageLogicalHeight() const FINAL;
