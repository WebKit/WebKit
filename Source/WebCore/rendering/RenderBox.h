...
public:
    ...
    LayoutRect NODELETE borderBoxRectInContainer() const final { return m_borderBoxRectInContainer; }
    ...
    inline bool tryLayoutDoingOutOfFlowMovementOnly();
    ...
    inline void markShapeOutsideDependentsForLayout();
