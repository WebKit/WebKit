...
public:
    ...
    LayoutUnit adjustBorderBoxLogicalWidthForBoxSizing(LayoutUnit computedLogicalWidth, const Style::Percentage<CSS::Nonnegative, float>&) const;
    LayoutUnit adjustBorderBoxLogicalWidthForBoxSizing(LayoutUnit computedLogicalWidth, const Style::UnevaluatedCalculation<CSS::LengthPercentage<CSS::Nonnegative, float>>&) const;

    LayoutUnit adjustContentBoxLogicalWidthForBoxSizing(const Style::Length<CSS::Nonnegative, float>& logicalWidth) const;
    LayoutUnit adjustContentBoxLogicalWidthForBoxSizing(LayoutUnit computedLogicalWidth, const Style::Percentage<CSS::Nonnegative, float>&) const;
    LayoutUnit adjustContentBoxLogicalWidthForBoxSizing(LayoutUnit computedLogicalWidth, const Style::UnevaluatedCalculation<CSS::LengthPercentage<CSS::Nonnegative, float>>&) const;
...
protected:
    ...
    std::optional<LayoutUnit> computeIntrinsicLogicalContentHeightUsing(CSS::Keyword::WebkitFillAvailable, std::optional<LayoutUnit> intrinsicContentHeight, LayoutUnit borderAndPadding) const;
    std::optional<LayoutUnit> computeIntrinsicLogicalContentHeightUsing(CSS::Keyword::Intrinsic, std::optional<LayoutUnit> intrinsicContentHeight, LayoutUnit borderAndPadding) const;
    std::optional<LayoutUnit> computeIntrinsicLogicalContentHeightUsing(CSS::Keyword::MinIntrinsic, std::optional<LayoutUnit> intrinsicContentHeight, LayoutUnit borderAndPadding) const;
    std::optional<LayoutUnit> computeIntrinsicLogicalContentHeightUsing(CSS::Keyword::MaxContent, std::optional<LayoutUnit> intrinsicContentHeight, LayoutUnit borderAndPadding) const;
    std::optional<LayoutUnit> computeIntrinsicLogicalContentHeightUsing(CSS::Keyword::MinContent, std::optional<LayoutUnit> intrinsicContentHeight, LayoutUnit borderAndPadding) const;
    std::optional<LayoutUnit> computeIntrinsicLogicalContentHeightUsing(CSS::Keyword::FitContent, std::optional<LayoutUnit> intrinsicContentHeight, LayoutUnit borderAndPadding) const;
...
private:
    ...
    template<typename SizeType> LayoutUnit adjustBorderBoxLogicalWidthForBoxSizing(LayoutUnit computedLogicalWidth, const SizeType& original) const;
    template<typename SizeType> LayoutUnit adjustContentBoxLogicalWidthForBoxSizing(LayoutUnit computedLogicalWidth, const SizeType& original) const;
    ...
    template<typename SizeType> LayoutUnit computePositionedLogicalWidthUsing(const SizeType& logicalWidth, const PositionedLayoutConstraints& inlineConstraints) const;
    template<typename SizeType> LayoutUnit computePositionedLogicalHeightUsing(const SizeType& logicalHeight, LayoutUnit computedHeight, const PositionedLayoutConstraints& blockConstraints) const;
