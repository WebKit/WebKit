...
inline bool RenderObject::isAtomicInlineLevelBox() const { return style().isDisplayInlineType() && !(style().display() == Style::Display::Inline && !isBlockLevelReplacedOrAtomicInline()); }
