...
public:
    ...
    virtual float platformFocusRingWidth() const { return 5; }
    float platformFocusRingOffset(float outlineWidth) const { return std::max<float>(outlineWidth - platformFocusRingWidth(), 0); }
