...
struct _WebKitDOMTestObjPrivate {
...
{
    WebKitDOMTestObjPrivate* priv = WEBKIT_DOM_TEST_OBJ(object)->priv;
...
static void webkit_dom_test_obj_init(WebKitDOMTestObj* self)
{
    WebKitDOMTestObjPrivate* priv = G_TYPE_INSTANCE_GET_PRIVATE(self, WEBKIT_TYPE_DOM_TEST_OBJ, WebKitDOMTestObjPrivate);
    self->priv = priv;
