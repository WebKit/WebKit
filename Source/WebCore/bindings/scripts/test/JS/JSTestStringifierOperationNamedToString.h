...
public:
    ...
    static JSTestStringifierOperationNamedToString* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestStringifierOperationNamedToString>&&);
...
public:
    JSTestStringifierOperationNamedToStringOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestStringifierOperationNamedToStringOwner(ClangVTableWorkaroundTag);
};
