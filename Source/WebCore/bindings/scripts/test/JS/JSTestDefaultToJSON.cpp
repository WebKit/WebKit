...
{
    return getDOMConstructor<JSTestDefaultToJSONDOMConstructor, DOMConstructorID::TestDefaultToJSON>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
