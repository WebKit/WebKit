...
{
    return getDOMConstructor<JSTestNamedGetterWithIdentifierDOMConstructor, DOMConstructorID::TestNamedGetterWithIdentifier>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
