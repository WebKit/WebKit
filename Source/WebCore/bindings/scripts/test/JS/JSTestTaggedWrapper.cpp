...
{
    return getDOMConstructor<JSTestTaggedWrapperDOMConstructor, DOMConstructorID::TestTaggedWrapper>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
