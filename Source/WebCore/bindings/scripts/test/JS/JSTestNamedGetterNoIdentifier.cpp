...
{
    return getDOMConstructor<JSTestNamedGetterNoIdentifierDOMConstructor, DOMConstructorID::TestNamedGetterNoIdentifier>(vm, *jsUncheckedDowncast<const JSDOMGlobalObject*>(globalObject));
}
...
bool JSTestNamedGetterNoIdentifier::legacyPlatformObjectGetOwnProperty(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyName propertyName, PropertySlot& slot, bool ignoreNamedProperties)
{
    ...
    auto* thisObject = jsUncheckedDowncast<JSTestNamedGetterNoIdentifier*>(object);
...
{
    auto* thisObject = jsUncheckedDowncast<JSTestNamedGetterNoIdentifier*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
JSC_DEFINE_CUSTOM_GETTER(jsTestNamedGetterNoIdentifierConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    SUPPRESS_UNCOUNTED_LOCAL auto& vm = JSC::getVM(lexicalGlobalObject);
    auto throwScope = DECLARE_THROW_SCOPE(vm);
    auto* prototype = jsDynamicDowncast<JSTestNamedGetterNoIdentifierPrototype*>(JSValue::decode(thisValue));
...
{
    if (auto* wrapper = jsDynamicDowncast<JSTestNamedGetterNoIdentifier*>(value))
