...
{
    return getDOMConstructor<JSWorkletGlobalScopeDOMConstructor, DOMConstructorID::WorkletGlobalScope>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
