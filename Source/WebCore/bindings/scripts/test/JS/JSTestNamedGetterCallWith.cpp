...
{
    return getDOMConstructor<JSTestNamedGetterCallWithDOMConstructor, DOMConstructorID::TestNamedGetterCallWith>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
