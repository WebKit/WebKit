...
{
    return getDOMConstructor<JSTestCEReactionsStringifierDOMConstructor, DOMConstructorID::TestCEReactionsStringifier>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
