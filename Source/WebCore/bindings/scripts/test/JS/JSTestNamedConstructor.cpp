...
static const HashTable JSTestNamedConstructorPrototypeTable = { 1, 1, true, JSTestNamedConstructorPrototypeTableValues, JSTestNamedConstructorPrototypeTableIndex };
