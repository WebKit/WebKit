...
{
    return getDOMConstructor<JSTestStringifierOperationNamedToStringDOMConstructor, DOMConstructorID::TestStringifierOperationNamedToString>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
