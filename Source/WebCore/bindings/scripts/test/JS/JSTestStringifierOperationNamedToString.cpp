...
{
    return getDOMConstructor<JSTestStringifierOperationNamedToStringDOMConstructor, DOMConstructorID::TestStringifierOperationNamedToString>(vm, *jsUncheckedDowncast<const JSDOMGlobalObject*>(globalObject));
}
...
JSC_DEFINE_CUSTOM_GETTER(jsTestStringifierOperationNamedToStringConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    auto* prototype = jsDynamicDowncast<JSTestStringifierOperationNamedToStringPrototype*>(JSValue::decode(thisValue));
...
{
    auto* thisObject = jsUncheckedDowncast<JSTestStringifierOperationNamedToString*>(cell);
...
{
    if (auto* wrapper = jsDynamicDowncast<JSTestStringifierOperationNamedToString*>(value))
