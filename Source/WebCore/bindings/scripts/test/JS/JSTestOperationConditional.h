...
public:
    ...
    static JSTestOperationConditional* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestOperationConditional>&&);
...
public:
    JSTestOperationConditionalOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestOperationConditionalOwner(ClangVTableWorkaroundTag);
};
