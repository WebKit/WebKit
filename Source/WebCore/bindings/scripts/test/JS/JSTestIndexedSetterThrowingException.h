...
public:
    ...
    static JSTestIndexedSetterThrowingException* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestIndexedSetterThrowingException>&&);
...
public:
    JSTestIndexedSetterThrowingExceptionOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestIndexedSetterThrowingExceptionOwner(ClangVTableWorkaroundTag);
};
