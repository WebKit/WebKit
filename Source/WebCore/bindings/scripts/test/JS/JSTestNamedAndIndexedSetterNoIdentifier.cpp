...
{
    return getDOMConstructor<JSTestNamedAndIndexedSetterNoIdentifierDOMConstructor, DOMConstructorID::TestNamedAndIndexedSetterNoIdentifier>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
