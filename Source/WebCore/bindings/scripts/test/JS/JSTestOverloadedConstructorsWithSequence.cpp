...
static inline EncodedJSValue constructJSTestOverloadedConstructorsWithSequence1(JSGlobalObject* lexicalGlobalObject, CallFrame* callFrame)
{
    ...
    auto sequenceOfStringsConversionResult = convertOptionalWithDefault<IDLSequence<IDLDOMString>>(*lexicalGlobalObject, argument0.value(), [&]() -> typename Converter<IDLSequence<IDLDOMString>>::ReturnType { return Converter<IDLSequence<IDLDOMString>>::ReturnType { }; });
...
static inline EncodedJSValue constructJSTestOverloadedConstructorsWithSequence2(JSGlobalObject* lexicalGlobalObject, CallFrame* callFrame)
{
    ...
    RETURN_IF_EXCEPTION(throwScope, encodedJSValue());
    ASSERT(!stringConversionResult.hasException());
