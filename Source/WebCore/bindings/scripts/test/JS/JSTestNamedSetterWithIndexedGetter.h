...
public:
    ...
    static JSTestNamedSetterWithIndexedGetter* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestNamedSetterWithIndexedGetter>&&);
...
public:
    JSTestNamedSetterWithIndexedGetterOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestNamedSetterWithIndexedGetterOwner(ClangVTableWorkaroundTag);
};
