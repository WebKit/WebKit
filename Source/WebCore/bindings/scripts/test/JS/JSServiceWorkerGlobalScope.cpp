...
template<> const unsigned JSServiceWorkerGlobalScopeDOMConstructor::StructureFlags = Base::StructureFlags;
...
static const struct CompactHashIndex JSServiceWorkerGlobalScopeInstanceTableIndex[2] = {
    { -1, -1 },
    { 0, -1 },
};
