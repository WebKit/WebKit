...
{
    return getDOMConstructor<JSTestNamedSetterWithIndexedGetterDOMConstructor, DOMConstructorID::TestNamedSetterWithIndexedGetter>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
