...
public:
    ...
    static JSTestNamedSetterWithIndexedGetterAndSetter* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestNamedSetterWithIndexedGetterAndSetter>&&);
...
public:
    JSTestNamedSetterWithIndexedGetterAndSetterOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestNamedSetterWithIndexedGetterAndSetterOwner(ClangVTableWorkaroundTag);
};
