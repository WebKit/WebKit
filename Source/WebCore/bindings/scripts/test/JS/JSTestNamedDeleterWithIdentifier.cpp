...
{
    return getDOMConstructor<JSTestNamedDeleterWithIdentifierDOMConstructor, DOMConstructorID::TestNamedDeleterWithIdentifier>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
