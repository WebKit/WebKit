...
{
    return getDOMConstructor<JSTestDefaultToJSONIndirectInheritanceDOMConstructor, DOMConstructorID::TestDefaultToJSONIndirectInheritance>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
