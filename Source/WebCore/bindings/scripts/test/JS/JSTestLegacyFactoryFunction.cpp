...
template<> EncodedJSValue JSC_HOST_CALL_ATTRIBUTES JSTestLegacyFactoryFunctionLegacyFactoryFunction::construct(JSGlobalObject* lexicalGlobalObject, CallFrame* callFrame)
{
    ...
    ASSERT(!str1ConversionResult.hasException());
    EnsureStillAliveScope argument1 = callFrame->argument(1);
    auto str2ConversionResult = convertOptionalWithDefault<IDLDOMString>(*lexicalGlobalObject, argument1.value(), [&]() -> typename Converter<IDLDOMString>::ReturnType { return "defaultString"_s; });
    RETURN_IF_EXCEPTION(throwScope, encodedJSValue());
    ASSERT(!str2ConversionResult.hasException());
    EnsureStillAliveScope argument2 = callFrame->argument(2);
    auto str3ConversionResult = convertOptionalWithDefault<IDLDOMString>(*lexicalGlobalObject, argument2.value(), [&]() -> typename Converter<IDLDOMString>::ReturnType { return String(); });
    RETURN_IF_EXCEPTION(throwScope, encodedJSValue());
    ASSERT(!str3ConversionResult.hasException());
