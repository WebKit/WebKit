...
public:
    ...
    static JSTestNamedDeleterWithIdentifier* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestNamedDeleterWithIdentifier>&&);
...
public:
    JSTestNamedDeleterWithIdentifierOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestNamedDeleterWithIdentifierOwner(ClangVTableWorkaroundTag);
};
