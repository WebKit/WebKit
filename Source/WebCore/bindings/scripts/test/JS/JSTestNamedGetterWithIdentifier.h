...
public:
    ...
    static JSTestNamedGetterWithIdentifier* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestNamedGetterWithIdentifier>&&);
...
public:
    JSTestNamedGetterWithIdentifierOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestNamedGetterWithIdentifierOwner(ClangVTableWorkaroundTag);
};
