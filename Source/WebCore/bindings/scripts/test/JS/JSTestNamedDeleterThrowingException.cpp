...
{
    return getDOMConstructor<JSTestNamedDeleterThrowingExceptionDOMConstructor, DOMConstructorID::TestNamedDeleterThrowingException>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
