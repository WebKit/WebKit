...
{
    return getDOMConstructor<JSTestNamedSetterWithLegacyOverrideBuiltInsDOMConstructor, DOMConstructorID::TestNamedSetterWithLegacyOverrideBuiltIns>(vm, *jsUncheckedDowncast<const JSDOMGlobalObject*>(globalObject));
}
...
bool JSTestNamedSetterWithLegacyOverrideBuiltIns::legacyPlatformObjectGetOwnProperty(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyName propertyName, PropertySlot& slot, bool ignoreNamedProperties)
{
    ...
    auto* thisObject = jsUncheckedDowncast<JSTestNamedSetterWithLegacyOverrideBuiltIns*>(object);
...
{
    auto* thisObject = jsUncheckedDowncast<JSTestNamedSetterWithLegacyOverrideBuiltIns*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
JSC_DEFINE_CUSTOM_GETTER(jsTestNamedSetterWithLegacyOverrideBuiltInsConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    SUPPRESS_UNCOUNTED_LOCAL auto& vm = JSC::getVM(lexicalGlobalObject);
    auto throwScope = DECLARE_THROW_SCOPE(vm);
    auto* prototype = jsDynamicDowncast<JSTestNamedSetterWithLegacyOverrideBuiltInsPrototype*>(JSValue::decode(thisValue));
...
{
    if (auto* wrapper = jsDynamicDowncast<JSTestNamedSetterWithLegacyOverrideBuiltIns*>(value))
