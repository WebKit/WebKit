...
public:
    ...
    static JSTestDelegateToSharedSyntheticAttribute* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestDelegateToSharedSyntheticAttribute>&&);
...
public:
    JSTestDelegateToSharedSyntheticAttributeOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestDelegateToSharedSyntheticAttributeOwner(ClangVTableWorkaroundTag);
};
