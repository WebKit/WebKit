...
{
    return getDOMConstructor<JSTestStringifierDOMConstructor, DOMConstructorID::TestStringifier>(vm, *jsUncheckedDowncast<const JSDOMGlobalObject*>(globalObject));
}
...
JSC_DEFINE_CUSTOM_GETTER(jsTestStringifierConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    auto* prototype = jsDynamicDowncast<JSTestStringifierPrototype*>(JSValue::decode(thisValue));
...
{
    auto* thisObject = jsUncheckedDowncast<JSTestStringifier*>(cell);
...
{
    if (auto* wrapper = jsDynamicDowncast<JSTestStringifier*>(value))
