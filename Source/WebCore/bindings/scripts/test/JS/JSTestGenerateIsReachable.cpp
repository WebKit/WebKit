...
static const HashTable JSTestGenerateIsReachablePrototypeTable = { 1, 1, true, JSTestGenerateIsReachablePrototypeTableValues, JSTestGenerateIsReachablePrototypeTableIndex };
