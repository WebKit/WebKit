...
{
    return getDOMConstructor<JSTestIndexedSetterThrowingExceptionDOMConstructor, DOMConstructorID::TestIndexedSetterThrowingException>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
