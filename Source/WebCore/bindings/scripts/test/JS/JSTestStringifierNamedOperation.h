...
public:
    ...
    static JSTestStringifierNamedOperation* create(JSC::Structure*, JSDOMGlobalObject*, Ref<TestStringifierNamedOperation>&&);
...
public:
    JSTestStringifierNamedOperationOwner() = default;
    bool isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown>, void* context, JSC::AbstractSlotVisitor&, ASCIILiteral*) final;
    void finalize(JSC::Handle<JSC::Unknown>, void* context) final;

private:
    explicit JSTestStringifierNamedOperationOwner(ClangVTableWorkaroundTag);
};
