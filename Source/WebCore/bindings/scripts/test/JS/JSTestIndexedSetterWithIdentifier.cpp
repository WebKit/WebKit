...
{
    return getDOMConstructor<JSTestIndexedSetterWithIdentifierDOMConstructor, DOMConstructorID::TestIndexedSetterWithIdentifier>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
