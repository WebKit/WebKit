...
{
    return getDOMConstructor<JSTestNamedSetterNoIdentifierDOMConstructor, DOMConstructorID::TestNamedSetterNoIdentifier>(vm, *uncheckedDowncast<const JSDOMGlobalObject>(globalObject));
}
