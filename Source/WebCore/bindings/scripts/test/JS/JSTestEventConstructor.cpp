...
static const HashTable JSTestEventConstructorPrototypeTable = { 4, 7, true, JSTestEventConstructorPrototypeTableValues, JSTestEventConstructorPrototypeTableIndex };
