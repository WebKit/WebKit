...
JSTestCallbackFunction::JSTestCallbackFunction(VM& vm, JSObject* callback)
    : TestCallbackFunction(jsCast<JSDOMGlobalObject*>(callback->globalObject(vm))->scriptExecutionContext())
