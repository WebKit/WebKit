...
public:
    ...
    void loadModuleScriptInWorld(LoadableModuleScript&, Ref<JSC::ScriptFetchParameters>&&, DOMWrapperWorld&);
    void loadModuleScript(LoadableModuleScript&, Ref<JSC::ScriptFetchParameters>&&);
