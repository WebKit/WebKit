...
template<typename JSClass> inline JSC::Structure* JSDOMBuiltinConstructor<JSClass>::getDOMStructureForJSObject(JSC::JSGlobalObject* lexicalGlobalObject, JSC::JSObject* newTarget)
{
    ...
    auto* baseStructure = getDOMStructure<JSClass>(vm, *JSC::jsUncheckedDowncast<JSDOMGlobalObject*>(newTargetGlobalObject));
...
{
    ASSERT(callFrame);
    auto* castedThis = JSC::jsUncheckedDowncast<JSDOMBuiltinConstructor*>(callFrame->jsCallee());
