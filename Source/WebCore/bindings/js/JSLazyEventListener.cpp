...
JSObject* JSLazyEventListener::initializeJSFunction(ScriptExecutionContext& executionContext) const
{
    ...
    if (m_originalNode) {
        ...
        if (listenerHasEventHandlerScope) {
            ...
            JSFunction* listenerAsFunction = jsUncheckedDowncast<JSFunction*>(jsFunction);
            listenerAsFunction->setScope(vm, jsUncheckedDowncast<JSHTMLElement*>(wrapper())->pushEventHandlerScope(lexicalGlobalObject, listenerAsFunction->scope()));
        }
    }
