...
public:
    ...
    void destroyJSWindowProxy(DOMWrapperWorld&, Frame* frameContainingDestroyedRealm = nullptr);
    ...
    void setDOMWindow(DOMWindow*, Frame* frameContainingPreviousRealm = nullptr);
