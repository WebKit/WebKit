...
struct FrameData {
    ...
    Vector<View> views;
    UnsafeHashMap<LayerHandle, UniqueRef<LayerData>> layers;
...
protected:
    ...
    using FeaturesPerModeMap = UnsafeHashMap<SessionMode, FeatureList, IntHash<SessionMode>, WTF::StrongEnumHashTraits<SessionMode>>;
