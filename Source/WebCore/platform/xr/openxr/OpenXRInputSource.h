...
public:
    using SuggestedBindings = UnsafeHashMap<const char*, Vector<XrActionSuggestedBinding>>;
...
private:
    ...
    using OpenXRButtonActionsMap = UnsafeHashMap<OpenXRButtonType, OpenXRButtonActions, IntHash<OpenXRButtonType>, WTF::StrongEnumHashTraits<OpenXRButtonType>>;
    OpenXRButtonActionsMap m_buttonActions;
    using OpenXRAxesMap = UnsafeHashMap<OpenXRAxisType, XrAction, IntHash<OpenXRAxisType>, WTF::StrongEnumHashTraits<OpenXRAxisType>>;
