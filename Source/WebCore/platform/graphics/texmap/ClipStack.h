...
public:
    ...
    const float* roundedRectComponents() const LIFETIME_BOUND { return m_roundedRectComponents.span().data(); }
    const float* roundedRectInverseTransformComponents() const LIFETIME_BOUND { return m_roundedRectInverseTransformComponents.span().data(); }
