...
Length SVGSVGElement::intrinsicWidthIgnoringCSSProperties() const
{
...
{
    if (widthAttributeEstablishesViewport())
        return intrinsicWidthIgnoringCSSProperties();

    ASSERT(renderer());
    return renderer()->style()->width();
}

Length SVGSVGElement::intrinsicHeightIgnoringCSSProperties() const
{
...
{
    if (heightAttributeEstablishesViewport())
        return intrinsicHeightIgnoringCSSProperties();
