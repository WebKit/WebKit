...
private:
    ...
    MemoryCompactRobinHoodHashMap<AtomString, WeakHashSet<Element, WeakPtrImplWithEventTargetData>> m_pendingResources; // Resources that are pending.
    MemoryCompactRobinHoodHashMap<AtomString, WeakHashSet<Element, WeakPtrImplWithEventTargetData>> m_pendingResourcesForRemoval; // Resources that are pending and scheduled for removal.
...
public:
    ...
    WeakHashSet<Element, WeakPtrImplWithEventTargetData> removePendingResource(const AtomString& id) { return m_pendingResources.take(id); }
