...
public:
    ...
    Ref<GStreamerRtpSenderBackend> createSenderBackend(ThreadSafeWeakPtr<GStreamerPeerConnectionBackend>&&, GStreamerRtpSenderBackend::Source&&, GUniquePtr<GstStructure>&&);
