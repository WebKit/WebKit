...
const ProcEntry g_procTable[] = {
    ...
    {"glFramebufferMTLRasterizationRateMapANGLE", P(GL_FramebufferMTLRasterizationRateMapANGLE)},
    ...
    {"glGetFramebufferMTLRasterizationRateMapANGLE", P(GL_GetFramebufferMTLRasterizationRateMapANGLE)},
