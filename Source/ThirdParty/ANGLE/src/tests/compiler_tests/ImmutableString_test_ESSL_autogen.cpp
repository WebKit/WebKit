...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x0000064cu, ImmutableString("gl_Position").mangledNameHash());
    ASSERT_EQ(0x0000064du, ImmutableString("gl_PointSize").mangledNameHash());
    ASSERT_EQ(0x0000064eu, ImmutableString("gl_InstanceID").mangledNameHash());
    ASSERT_EQ(0x00000650u, ImmutableString("gl_VertexID").mangledNameHash());
    ASSERT_EQ(0x00000653u, ImmutableString("gl_DrawID").mangledNameHash());
    ASSERT_EQ(0x00000654u, ImmutableString("gl_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x00000655u, ImmutableString("gl_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x00000656u, ImmutableString("angle_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x00000657u, ImmutableString("angle_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x00000658u, ImmutableString("gl_ClipDistance").mangledNameHash());
    ASSERT_EQ(0x00000659u, ImmutableString("gl_NumWorkGroups").mangledNameHash());
    ASSERT_EQ(0x0000065au, ImmutableString("gl_WorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x0000065bu, ImmutableString("gl_WorkGroupID").mangledNameHash());
    ASSERT_EQ(0x0000065cu, ImmutableString("gl_LocalInvocationID").mangledNameHash());
    ASSERT_EQ(0x0000065du, ImmutableString("gl_GlobalInvocationID").mangledNameHash());
    ASSERT_EQ(0x0000065eu, ImmutableString("gl_LocalInvocationIndex").mangledNameHash());
    ASSERT_EQ(0x0000065fu, ImmutableString("gl_PrimitiveIDIn").mangledNameHash());
    ASSERT_EQ(0x00000660u, ImmutableString("gl_InvocationID").mangledNameHash());
    ASSERT_EQ(0x00000661u, ImmutableString("gl_PerVertex").mangledNameHash());
    ASSERT_EQ(0x00000662u, ImmutableString("gl_in").mangledNameHash());
    ASSERT_EQ(0x00000663u, ImmutableString("gl_PatchVerticesIn").mangledNameHash());
    ASSERT_EQ(0x00000664u, ImmutableString("gl_TessLevelOuter").mangledNameHash());
    ASSERT_EQ(0x00000665u, ImmutableString("gl_TessLevelInner").mangledNameHash());
    ASSERT_EQ(0x00000666u, ImmutableString("gl_out").mangledNameHash());
    ASSERT_EQ(0x00000667u, ImmutableString("gl_BoundingBox").mangledNameHash());
    ASSERT_EQ(0x00000668u, ImmutableString("gl_BoundingBoxEXT").mangledNameHash());
    ASSERT_EQ(0x00000669u, ImmutableString("gl_BoundingBoxOES").mangledNameHash());
    ASSERT_EQ(0x0000066au, ImmutableString("gl_TessCoord").mangledNameHash());
    ASSERT_EQ(0x0000066bu, ImmutableString("gl_ViewID_OVR").mangledNameHash());
    ASSERT_EQ(0x0000066cu, ImmutableString("gl_CullDistance").mangledNameHash());
