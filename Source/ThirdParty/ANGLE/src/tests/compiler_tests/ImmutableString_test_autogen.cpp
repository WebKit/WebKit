...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x00000871u, ImmutableString("gl_Position").mangledNameHash());
    ASSERT_EQ(0x00000872u, ImmutableString("gl_PointSize").mangledNameHash());
    ASSERT_EQ(0x00000873u, ImmutableString("gl_InstanceID").mangledNameHash());
    ASSERT_EQ(0x00000875u, ImmutableString("gl_VertexID").mangledNameHash());
    ASSERT_EQ(0x00000878u, ImmutableString("gl_DrawID").mangledNameHash());
    ASSERT_EQ(0x00000879u, ImmutableString("gl_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x0000087au, ImmutableString("gl_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x0000087bu, ImmutableString("angle_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x0000087cu, ImmutableString("angle_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x0000087du, ImmutableString("gl_ClipDistance").mangledNameHash());
    ASSERT_EQ(0x0000087eu, ImmutableString("gl_NumWorkGroups").mangledNameHash());
    ASSERT_EQ(0x0000087fu, ImmutableString("gl_WorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x00000880u, ImmutableString("gl_WorkGroupID").mangledNameHash());
    ASSERT_EQ(0x00000881u, ImmutableString("gl_LocalInvocationID").mangledNameHash());
    ASSERT_EQ(0x00000882u, ImmutableString("gl_GlobalInvocationID").mangledNameHash());
    ASSERT_EQ(0x00000883u, ImmutableString("gl_LocalInvocationIndex").mangledNameHash());
    ASSERT_EQ(0x00000884u, ImmutableString("gl_PrimitiveIDIn").mangledNameHash());
    ASSERT_EQ(0x00000885u, ImmutableString("gl_InvocationID").mangledNameHash());
    ASSERT_EQ(0x00000886u, ImmutableString("gl_PerVertex").mangledNameHash());
    ASSERT_EQ(0x00000887u, ImmutableString("gl_in").mangledNameHash());
    ASSERT_EQ(0x00000888u, ImmutableString("gl_PatchVerticesIn").mangledNameHash());
    ASSERT_EQ(0x00000889u, ImmutableString("gl_TessLevelOuter").mangledNameHash());
    ASSERT_EQ(0x0000088au, ImmutableString("gl_TessLevelInner").mangledNameHash());
    ASSERT_EQ(0x0000088bu, ImmutableString("gl_out").mangledNameHash());
    ASSERT_EQ(0x0000088cu, ImmutableString("gl_BoundingBox").mangledNameHash());
    ASSERT_EQ(0x0000088du, ImmutableString("gl_BoundingBoxEXT").mangledNameHash());
    ASSERT_EQ(0x0000088eu, ImmutableString("gl_BoundingBoxOES").mangledNameHash());
    ASSERT_EQ(0x0000088fu, ImmutableString("gl_TessCoord").mangledNameHash());
    ASSERT_EQ(0x00000890u, ImmutableString("gl_ViewID_OVR").mangledNameHash());
    ASSERT_EQ(0x00000891u, ImmutableString("gl_CullDistance").mangledNameHash());
