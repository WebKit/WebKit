...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x000007f2u, ImmutableString("noise1(00B").mangledNameHash());
    ASSERT_EQ(0x000007f3u, ImmutableString("noise1(10B").mangledNameHash());
    ASSERT_EQ(0x000007f4u, ImmutableString("noise1(20B").mangledNameHash());
    ASSERT_EQ(0x000007f5u, ImmutableString("noise1(30B").mangledNameHash());
    ASSERT_EQ(0x000007f6u, ImmutableString("noise2(00B").mangledNameHash());
    ASSERT_EQ(0x000007f7u, ImmutableString("noise2(10B").mangledNameHash());
    ASSERT_EQ(0x000007f8u, ImmutableString("noise2(20B").mangledNameHash());
    ASSERT_EQ(0x000007f9u, ImmutableString("noise2(30B").mangledNameHash());
    ASSERT_EQ(0x000007fau, ImmutableString("noise3(00B").mangledNameHash());
    ASSERT_EQ(0x000007fbu, ImmutableString("noise3(10B").mangledNameHash());
    ASSERT_EQ(0x000007fcu, ImmutableString("noise3(20B").mangledNameHash());
    ASSERT_EQ(0x000007fdu, ImmutableString("noise3(30B").mangledNameHash());
    ASSERT_EQ(0x000007feu, ImmutableString("noise4(00B").mangledNameHash());
    ASSERT_EQ(0x000007ffu, ImmutableString("noise4(10B").mangledNameHash());
    ASSERT_EQ(0x00000800u, ImmutableString("noise4(20B").mangledNameHash());
    ASSERT_EQ(0x00000801u, ImmutableString("noise4(30B").mangledNameHash());
    ASSERT_EQ(0x00000802u, ImmutableString("memoryBarrier(").mangledNameHash());
    ASSERT_EQ(0x00000803u, ImmutableString("memoryBarrierAtomicCounter(").mangledNameHash());
    ASSERT_EQ(0x00000804u, ImmutableString("memoryBarrierBuffer(").mangledNameHash());
    ASSERT_EQ(0x00000805u, ImmutableString("memoryBarrierImage(").mangledNameHash());
    ASSERT_EQ(0x00000806u, ImmutableString("barrier(").mangledNameHash());
    ASSERT_EQ(0x00000807u, ImmutableString("memoryBarrierShared(").mangledNameHash());
    ASSERT_EQ(0x00000808u, ImmutableString("groupMemoryBarrier(").mangledNameHash());
    ASSERT_EQ(0x00000809u, ImmutableString("EmitVertex(").mangledNameHash());
    ASSERT_EQ(0x0000080au, ImmutableString("EndPrimitive(").mangledNameHash());
    ASSERT_EQ(0x0000080bu, ImmutableString("EmitStreamVertex(00D").mangledNameHash());
    ASSERT_EQ(0x0000080cu, ImmutableString("EndStreamPrimitive(00D").mangledNameHash());
    ASSERT_EQ(0x0000080du, ImmutableString("subpassLoad(01j").mangledNameHash());
    ASSERT_EQ(0x0000080eu, ImmutableString("subpassLoad(01k").mangledNameHash());
    ASSERT_EQ(0x0000080fu, ImmutableString("subpassLoad(01l").mangledNameHash());
    ASSERT_EQ(0x00000810u, ImmutableString("subpassLoad(01m00D").mangledNameHash());
    ASSERT_EQ(0x00000811u, ImmutableString("subpassLoad(01n00D").mangledNameHash());
    ASSERT_EQ(0x00000812u, ImmutableString("subpassLoad(01o00D").mangledNameHash());
    ASSERT_EQ(0x00000813u, ImmutableString("anyInvocation(00F").mangledNameHash());
    ASSERT_EQ(0x00000814u, ImmutableString("allInvocations(00F").mangledNameHash());
    ASSERT_EQ(0x00000815u, ImmutableString("allInvocationsEqual(00F").mangledNameHash());
    ASSERT_EQ(0x00000816u, ImmutableString("gl_DepthRangeParameters").mangledNameHash());
    ASSERT_EQ(0x00000817u, ImmutableString("gl_DepthRange").mangledNameHash());
    ASSERT_EQ(0x00000818u, ImmutableString("gl_NumSamples").mangledNameHash());
    ASSERT_EQ(0x00000819u, ImmutableString("gl_MaxVertexAttribs").mangledNameHash());
    ASSERT_EQ(0x0000081au, ImmutableString("gl_MaxVertexUniformVectors").mangledNameHash());
    ASSERT_EQ(0x0000081bu, ImmutableString("gl_MaxVertexTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x0000081cu, ImmutableString("gl_MaxCombinedTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x0000081du, ImmutableString("gl_MaxTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x0000081eu, ImmutableString("gl_MaxFragmentUniformVectors").mangledNameHash());
    ASSERT_EQ(0x0000081fu, ImmutableString("gl_MaxVaryingVectors").mangledNameHash());
    ASSERT_EQ(0x00000820u, ImmutableString("gl_MaxDrawBuffers").mangledNameHash());
    ASSERT_EQ(0x00000821u, ImmutableString("gl_MaxDualSourceDrawBuffersEXT").mangledNameHash());
    ASSERT_EQ(0x00000822u, ImmutableString("gl_MaxVertexOutputVectors").mangledNameHash());
    ASSERT_EQ(0x00000823u, ImmutableString("gl_MaxFragmentInputVectors").mangledNameHash());
    ASSERT_EQ(0x00000824u, ImmutableString("gl_MinProgramTexelOffset").mangledNameHash());
    ASSERT_EQ(0x00000825u, ImmutableString("gl_MaxProgramTexelOffset").mangledNameHash());
    ASSERT_EQ(0x00000826u, ImmutableString("gl_MaxImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000827u, ImmutableString("gl_MaxVertexImageUniforms").mangledNameHash());
    ASSERT_EQ(0x00000828u, ImmutableString("gl_MaxFragmentImageUniforms").mangledNameHash());
    ASSERT_EQ(0x00000829u, ImmutableString("gl_MaxComputeImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000082au, ImmutableString("gl_MaxCombinedImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000082bu,
              ImmutableString("gl_MaxCombinedShaderOutputResources").mangledNameHash());
    ASSERT_EQ(0x0000082cu, ImmutableString("gl_MaxComputeWorkGroupCount").mangledNameHash());
    ASSERT_EQ(0x0000082du, ImmutableString("gl_MaxComputeWorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x0000082eu, ImmutableString("gl_MaxComputeUniformComponents").mangledNameHash());
    ASSERT_EQ(0x0000082fu, ImmutableString("gl_MaxComputeTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000830u, ImmutableString("gl_MaxComputeAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000831u, ImmutableString("gl_MaxComputeAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000832u, ImmutableString("gl_MaxVertexAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000833u, ImmutableString("gl_MaxFragmentAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000834u, ImmutableString("gl_MaxCombinedAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000835u, ImmutableString("gl_MaxAtomicCounterBindings").mangledNameHash());
    ASSERT_EQ(0x00000836u, ImmutableString("gl_MaxVertexAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000837u, ImmutableString("gl_MaxFragmentAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000838u, ImmutableString("gl_MaxCombinedAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000839u, ImmutableString("gl_MaxAtomicCounterBufferSize").mangledNameHash());
    ASSERT_EQ(0x0000083au, ImmutableString("gl_MaxGeometryInputComponents").mangledNameHash());
    ASSERT_EQ(0x0000083bu, ImmutableString("gl_MaxGeometryOutputComponents").mangledNameHash());
    ASSERT_EQ(0x0000083cu, ImmutableString("gl_MaxGeometryImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000083du, ImmutableString("gl_MaxGeometryTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x0000083eu, ImmutableString("gl_MaxGeometryOutputVertices").mangledNameHash());
    ASSERT_EQ(0x0000083fu,
              ImmutableString("gl_MaxGeometryTotalOutputComponents").mangledNameHash());
    ASSERT_EQ(0x00000840u, ImmutableString("gl_MaxGeometryUniformComponents").mangledNameHash());
    ASSERT_EQ(0x00000841u, ImmutableString("gl_MaxGeometryAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000842u, ImmutableString("gl_MaxGeometryAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000843u, ImmutableString("gl_MaxTessControlInputComponents").mangledNameHash());
    ASSERT_EQ(0x00000844u, ImmutableString("gl_MaxTessControlOutputComponents").mangledNameHash());
    ASSERT_EQ(0x00000845u, ImmutableString("gl_MaxTessControlTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000846u, ImmutableString("gl_MaxTessControlUniformComponents").mangledNameHash());
    ASSERT_EQ(0x00000847u,
              ImmutableString("gl_MaxTessControlTotalOutputComponents").mangledNameHash());
    ASSERT_EQ(0x00000848u, ImmutableString("gl_MaxTessControlImageUniforms").mangledNameHash());
    ASSERT_EQ(0x00000849u, ImmutableString("gl_MaxTessControlAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x0000084au,
              ImmutableString("gl_MaxTessControlAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x0000084bu, ImmutableString("gl_MaxTessPatchComponents").mangledNameHash());
    ASSERT_EQ(0x0000084cu, ImmutableString("gl_MaxPatchVertices").mangledNameHash());
    ASSERT_EQ(0x0000084du, ImmutableString("gl_MaxTessGenLevel").mangledNameHash());
    ...
    ASSERT_EQ(0x00000850u,
              ImmutableString("gl_MaxTessEvaluationTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000851u,
              ImmutableString("gl_MaxTessEvaluationUniformComponents").mangledNameHash());
    ASSERT_EQ(0x00000852u, ImmutableString("gl_MaxTessEvaluationImageUniforms").mangledNameHash());
    ASSERT_EQ(0x00000853u, ImmutableString("gl_MaxTessEvaluationAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000854u,
              ImmutableString("gl_MaxTessEvaluationAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000855u, ImmutableString("gl_MaxSamples").mangledNameHash());
    ASSERT_EQ(0x00000856u, ImmutableString("gl_MaxClipDistances").mangledNameHash());
    ASSERT_EQ(0x00000857u, ImmutableString("gl_MaxCullDistances").mangledNameHash());
    ASSERT_EQ(0x00000858u, ImmutableString("gl_MaxCombinedClipAndCullDistances").mangledNameHash());
    ASSERT_EQ(0x00000859u, ImmutableString("gl_FragCoord").mangledNameHash());
    ASSERT_EQ(0x0000085au, ImmutableString("gl_FrontFacing").mangledNameHash());
    ASSERT_EQ(0x0000085bu, ImmutableString("gl_PointCoord").mangledNameHash());
    ASSERT_EQ(0x0000085cu, ImmutableString("gl_FragColor").mangledNameHash());
    ASSERT_EQ(0x0000085du, ImmutableString("gl_FragData").mangledNameHash());
    ASSERT_EQ(0x0000085eu, ImmutableString("gl_FragDepth").mangledNameHash());
    ASSERT_EQ(0x0000085fu, ImmutableString("gl_HelperInvocation").mangledNameHash());
    ASSERT_EQ(0x00000860u, ImmutableString("gl_SecondaryFragColorEXT").mangledNameHash());
    ASSERT_EQ(0x00000861u, ImmutableString("gl_SecondaryFragDataEXT").mangledNameHash());
    ASSERT_EQ(0x00000862u, ImmutableString("gl_FragDepthEXT").mangledNameHash());
    ASSERT_EQ(0x00000863u, ImmutableString("gl_LastFragData").mangledNameHash());
    ASSERT_EQ(0x00000864u, ImmutableString("gl_LastFragColor").mangledNameHash());
    ASSERT_EQ(0x00000865u, ImmutableString("gl_LastFragColorARM").mangledNameHash());
    ASSERT_EQ(0x00000866u, ImmutableString("gl_PrimitiveID").mangledNameHash());
    ASSERT_EQ(0x00000867u, ImmutableString("gl_Layer").mangledNameHash());
    ASSERT_EQ(0x00000868u, ImmutableString("gl_SampleID").mangledNameHash());
    ASSERT_EQ(0x00000869u, ImmutableString("gl_SamplePosition").mangledNameHash());
    ASSERT_EQ(0x0000086au, ImmutableString("gl_SampleMaskIn").mangledNameHash());
    ASSERT_EQ(0x0000086bu, ImmutableString("gl_SampleMask").mangledNameHash());
    ASSERT_EQ(0x0000086cu, ImmutableString("gl_CullDistance").mangledNameHash());
    ASSERT_EQ(0x0000086du, ImmutableString("gl_ClipDistance").mangledNameHash());
    ASSERT_EQ(0x0000086eu, ImmutableString("gl_Position").mangledNameHash());
    ASSERT_EQ(0x0000086fu, ImmutableString("gl_PointSize").mangledNameHash());
    ASSERT_EQ(0x00000870u, ImmutableString("gl_InstanceID").mangledNameHash());
    ASSERT_EQ(0x00000872u, ImmutableString("gl_VertexID").mangledNameHash());
    ASSERT_EQ(0x00000875u, ImmutableString("gl_DrawID").mangledNameHash());
    ASSERT_EQ(0x00000876u, ImmutableString("gl_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x00000877u, ImmutableString("gl_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x00000878u, ImmutableString("angle_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x00000879u, ImmutableString("angle_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x0000087au, ImmutableString("gl_NumWorkGroups").mangledNameHash());
    ASSERT_EQ(0x0000087bu, ImmutableString("gl_WorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x0000087cu, ImmutableString("gl_WorkGroupID").mangledNameHash());
    ASSERT_EQ(0x0000087du, ImmutableString("gl_LocalInvocationID").mangledNameHash());
    ASSERT_EQ(0x0000087eu, ImmutableString("gl_GlobalInvocationID").mangledNameHash());
    ASSERT_EQ(0x0000087fu, ImmutableString("gl_LocalInvocationIndex").mangledNameHash());
    ASSERT_EQ(0x00000880u, ImmutableString("gl_PrimitiveIDIn").mangledNameHash());
    ASSERT_EQ(0x00000881u, ImmutableString("gl_InvocationID").mangledNameHash());
    ASSERT_EQ(0x00000882u, ImmutableString("gl_PerVertex").mangledNameHash());
    ASSERT_EQ(0x00000883u, ImmutableString("gl_in").mangledNameHash());
    ASSERT_EQ(0x00000884u, ImmutableString("gl_PatchVerticesIn").mangledNameHash());
    ASSERT_EQ(0x00000885u, ImmutableString("gl_TessLevelOuter").mangledNameHash());
    ASSERT_EQ(0x00000886u, ImmutableString("gl_TessLevelInner").mangledNameHash());
    ASSERT_EQ(0x00000887u, ImmutableString("gl_out").mangledNameHash());
    ASSERT_EQ(0x00000888u, ImmutableString("gl_BoundingBox").mangledNameHash());
    ASSERT_EQ(0x00000889u, ImmutableString("gl_BoundingBoxEXT").mangledNameHash());
    ASSERT_EQ(0x0000088au, ImmutableString("gl_BoundingBoxOES").mangledNameHash());
    ASSERT_EQ(0x0000088bu, ImmutableString("gl_TessCoord").mangledNameHash());
    ASSERT_EQ(0x0000088cu, ImmutableString("gl_ViewID_OVR").mangledNameHash());
    ...
    ASSERT_EQ(0x000000c1u, ImmutableString("noise1").unmangledNameHash());
    ASSERT_EQ(0x000000c2u, ImmutableString("noise2").unmangledNameHash());
    ASSERT_EQ(0x000000c3u, ImmutableString("noise3").unmangledNameHash());
    ASSERT_EQ(0x000000c4u, ImmutableString("noise4").unmangledNameHash());
    ASSERT_EQ(0x000000c5u, ImmutableString("memoryBarrier").unmangledNameHash());
    ASSERT_EQ(0x000000c6u, ImmutableString("memoryBarrierAtomicCounter").unmangledNameHash());
    ASSERT_EQ(0x000000c7u, ImmutableString("memoryBarrierBuffer").unmangledNameHash());
    ASSERT_EQ(0x000000c8u, ImmutableString("memoryBarrierImage").unmangledNameHash());
    ASSERT_EQ(0x000000c9u, ImmutableString("barrier").unmangledNameHash());
    ASSERT_EQ(0x000000cau, ImmutableString("memoryBarrierShared").unmangledNameHash());
    ASSERT_EQ(0x000000cbu, ImmutableString("groupMemoryBarrier").unmangledNameHash());
    ASSERT_EQ(0x000000ccu, ImmutableString("EmitVertex").unmangledNameHash());
    ASSERT_EQ(0x000000cdu, ImmutableString("EndPrimitive").unmangledNameHash());
    ASSERT_EQ(0x000000ceu, ImmutableString("EmitStreamVertex").unmangledNameHash());
    ASSERT_EQ(0x000000cfu, ImmutableString("EndStreamPrimitive").unmangledNameHash());
    ASSERT_EQ(0x000000d0u, ImmutableString("subpassLoad").unmangledNameHash());
    ASSERT_EQ(0x000000d1u, ImmutableString("anyInvocation").unmangledNameHash());
    ASSERT_EQ(0x000000d2u, ImmutableString("allInvocations").unmangledNameHash());
    ASSERT_EQ(0x000000d3u, ImmutableString("allInvocationsEqual").unmangledNameHash());
}
