...
MSG kFramebufferFoveationAttachmentChanged = "Attachments have been changed on a framebuffer configured for foveated rendering";
...
MSG kFramebufferIncompleteFoveatedRendering = "Framebuffer is incomplete: Invalid framebuffer configuration for foveated rendering.";
...
MSG kInvalidAttribList = "Invalid texture storage attrib list.";
...
MSG kPLSDrawProgramActivePlanesUnused = "Active pixel local storage plane(s) are not referenced by the draw program.";
MSG kPLSDrawProgramFormatMismatch = "Pixel local storage formats in the draw program do not match actively bound planes.";
MSG kPLSDrawProgramPlanesInactive = "Draw program references pixel local storage plane(s) that are not currently active.";
...
MSG kPLSAdvancedBlendEnabled = "Attempted to begin pixel local storage with an advanced blend equation enabled.";
MSG kPLSAdvancedBlendNotSupported = "Advanced blend equations are not supported when pixel local storage is active.";
MSG kPLSRasterizerDiscardEnabled = "Attempted to begin pixel local storage with GL_RASTERIZER_DISCARD enabled.";
MSG kPLSTransformFeedbackActive = "Attempted to begin pixel local storage with transform feedback active.";
...
MSG kPLSSecondaryBlendEnabled = "Attempted to begin pixel local storage with a blend function requiring the secondary color input.";
MSG kPLSSecondaryBlendNotSupported = "Blend functions requiring the secondary color input are not supported when pixel local storage is active.";
...
MSG kTessellationShaderEXTNotEnabled = "GL_EXT_tessellation_shader extension not enabled.";
...
MSG kTextureFixedCompressedNotSupportBindImageTexture = "Fixed rate compressed texture image not supported in glBindImageTexture.";
...
MSG kTextureStorageCompressionExtensionRequired = "GL_EXT_texture_storage_compression not enabled";
...
MSG kTilingEndCalledWithoutStart = "EndTiling called without corresponding StartTiling.";
MSG kTilingStartCalledWithoutEnd = "StartTiling called without corresponding EndTiling.";
...
MSG kUnsupportedColorMaskForSharedExponentColorBuffer = "Color writemask for a GL_RGB9_E5 draw buffer must have the same values for red, green, and blue channels.";
