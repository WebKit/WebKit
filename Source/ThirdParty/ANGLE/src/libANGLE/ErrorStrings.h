...
inline constexpr const char *kBufSizeNotZeroForTexImage = "The bufSize is not 0 and either a pixel unpack buffer is bound or the data pointer is null.";
inline constexpr const char *kBufSizeTooSmallForTexImage = "The bufSize is smaller than the texture data size.";
...
inline constexpr const char *kCompressedTextureImageSizeMismatch = "The <imageSize> does not match the expected data size for the format and dimensions of the compressed image.";
...
inline constexpr const char *kCubemapFaceNotSquare = "The <width> is not equal to <height> for a cube map face.";
...
inline constexpr const char *kCubemapInvalidDepth = "The <depth> for a cube map array is not a multiple of 6.";
inline constexpr const char *kDataNULL = "The data is null.";
...
inline constexpr const char *kDepthFormatCubemap = "The current context does not support depth or combined depth/stencil formats for cube maps.";
...
inline constexpr const char *kEGLImageProtectedStateMismatch = "The <image> protected content state does not match the context protected content state.";
inline constexpr const char *kEGLImageRenderbufferFormatNotSupported = "The <image> internal format is not renderable.";
inline constexpr const char *kEGLImageRenderbufferUnsupportedSource = "The <image> has multiple levels, layers, or samples.";
...
inline constexpr const char *kExceedsFramebufferLimit = "The <param> is negative or greater than the value of the corresponding limit.";
...
inline constexpr const char *kIndexExceedsSamples = "The <index> is greater than or equal to the number of samples.";
...
inline constexpr const char *kInstanceIdOverflow = "baseinstance + primcount - 1 overflows GLuint.";
...
inline constexpr const char *kInternalFormatPalettedTarget = "The internal format is paletted and the <target> is not TEXTURE_2D.";
inline constexpr const char *kInternalFormatRequiresTexture2D = "internalformat is an ETC1 or PVRTC1 format.";
inline constexpr const char *kInternalFormatRequiresTexture3D = "The internal format has 3D blocks and the <target> is not TEXTURE_3D.";
inline constexpr const char *kInternalFormatNotSupportedTexture3D = "The format is not supported for 3D textures.";
inline constexpr const char *kInternalFormatNotSupportedTexStorage = "The <internalformat> is not a sized or compressed texture format or it is unsupported in the current context.";
...
inline constexpr const char *kInvalidBorder = "Border is not 0.";
inline constexpr const char *kInvalidBufferName = "name is not a valid buffer.";
inline constexpr const char *kInvalidBufferTarget = "Invalid buffer target.";
...
inline constexpr const char *kInvalidCompressedInternalFormat = "Internal format 0x%04X is not a valid compressed format in the current context.";
...
inline constexpr const char *kInvalidMipLevelForTarget = "The <level> is negative or greater than the maximum supported level for <target>.";
inline constexpr const char *kInvalidMipLevelPalettePositive = "The <level> is positive and the format is paletted.";
inline constexpr const char *kInvalidMipLevelPaletteCount = "The total number of levels derived from <level> for a paletted format exceeds the number of levels possible for the dimensions.";
...
inline constexpr const char *kInvalidPackUnpackAlignment = "Alignment is not 1, 2, 4, or 8.";
inline constexpr const char *kInvalidPatchVerticesValue = "The <value> is less than or equal to zero, or greater than MAX_PATCH_VERTICES.";
...
inline constexpr const char *kLevelsGreaterThanMax = "The <levels> value is greater than the maximum possible for the texture target, internal format, or dimensions.";
inline constexpr const char *kLevelsLessThanMax = "The <levels> value does not form a full set of mipmaps for the specified dimensions and the current context does not support partial mipmaps.";
...
inline constexpr const char *kNegativeParamCount = "Negative paramCount.";
...
inline constexpr const char *kNoActiveTessellationControlShaderStage = "No active tessellation control shader stage in this program.";
inline constexpr const char *kNoActiveTessellationEvaluationShaderStage = "No active tessellation evaluation shader stage in this program.";
...
inline constexpr const char *kNonPositiveDimensions = "One or more image dimensions are not positive.";
...
inline constexpr const char *kNonPositiveLevels = "The <levels> value is not positive.";
...
inline constexpr const char *kSubregionDimensionsBlockSize = "One or more subregion dimensions are not multiples of the compressed format block size and do not reach image bounds.";
inline constexpr const char *kSubregionDimensionsNegative = "One or more subregion dimensions are negative.";
inline constexpr const char *kSubregionDimensionsOutOfBounds = "One or more subregion dimensions are outside of the image.";
inline constexpr const char *kSubregionFormat = "The <format> does not match the internal format of the image.";
inline constexpr const char *kSubregionOffsetsBlockSize = "One or more subregion offsets are not multiples of the compressed format block size.";
inline constexpr const char *kSubregionOffsetsNegative = "One or more subregion offsets are negative.";
inline constexpr const char *kSubregionOffsetsOutOfBounds = "One or more subregion offsets are outside of the image.";
inline constexpr const char *kSubregionUpdateETC1 = "The texture image is ETC1 and the corresponding subregion update extensions are not enabled.";
inline constexpr const char *kSubregionUpdatePVRTC1 = "The texture image is PVRTC1 and the specified subregion is not equal to the image dimensions.";
...
inline constexpr const char *kPLSColorAttachment0PresentButDrawBufferDisabled = "Color attachment zero is present, but draw buffer zero is disabled.";
inline constexpr const char *kPLSActiveBackingTextureModification = "Pixel local storage is active and the texture is bound as its plane.";
inline constexpr const char *kPLSActiveTextureAttachmentRedefinition = "Pixel local storage is active and the texture is attached to the draw framebuffer.";
inline constexpr const char *kPLSActiveRenderbufferAttachmentRedefinition = "Pixel local storage is active and the renderbuffer is attached to the draw framebuffer.";
...
inline constexpr const char *kPLSDrawProgramColorAttachment0WorkaroundViolation = "Fragment shader declares index zero output, but color attachment zero is not present or of incompatible numeric type.";
...
inline constexpr const char *kPLSDrawProgramNoncoherentMismatch = "Pixel local storage planes with GL_PIXEL_LOCAL_USAGE_ALWAYS_NONCOHERENT_BIT_ANGLE do not have noncoherent bindings in the draw program.";
...
inline constexpr const char *kPLSInvalidUsage = "Invalid pixel local storage usage.";
...
inline constexpr const char *kPLSFramebufferDefaultDimensionsNotZero = "Draw framebuffer default width or height are not zeros.";
inline constexpr const char *kPLSImageUnitTextureBound = "An image unit overlapping with a PLS plane has a texture bound.";
...
inline constexpr const char *kTargetUnknown = "The <target> is unknown.";
inline constexpr const char *kTargetUnsupported = "The 0x%04X <target> is not supported in the current context.";
...
inline constexpr const char *kTextureDimensionsBCn = "The implied base level dimensions for an S3TC, RGTC, or BPTC texture are not multiples of 4.";
inline constexpr const char *kTextureDimensionsPVRTC1 = "A PVRTC1 texture has either not square or not power-of-two dimensions.";
...
inline constexpr const char *kTextureTargetInvalid = "The 0x%04X <target> is not supported in the current context or its dimensionality does not match the command.";
...
inline constexpr const char *kUnimplementedPaletteLevels = "Multi-level paletted textures are not implemented.";
...
inline constexpr const char *kUnsupportedColorMaskForSharedExponentColorBuffer = "Color writemask for a GL_RGB9_E5 draw buffer must have the same values for red, green, blue, and alpha channels.";
...
inline constexpr const char *kYUVFormatNot2DTarget = "The YUV <internalformat> supports only 2D textures and the specified <target> is not TEXTURE_2D.";
