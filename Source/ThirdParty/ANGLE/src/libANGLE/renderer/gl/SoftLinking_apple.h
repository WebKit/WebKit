...
#define SOFT_LINK_FRAMEWORK_HEADER(framework) \
    extern void* framework##Library(); \
...
#define SOFT_LINK_FUNCTION_HEADER(framework, functionName, resultType, parameterDeclarations, parameterNames) \
    EXTERN_C_BEGIN \
