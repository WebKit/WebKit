...
vars = {
  ...
  'chromium_revision': '198e6d1c360e26159232c97916afc641bcf99021',
  ...
  'catapult_revision': 'fdcbdb2b3eece968d35fe374169fd94080eeea54',

  # the commit queue can handle CLs rolling Fuchsia sdk
  # and whatever else without interference from each other.
  'fuchsia_version': 'version:12.20230402.3.1',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@b3fc6af816c433dd88644ff2356cfd2922b2cef0',
    'condition': 'not build_with_chromium',
  },

  'buildtools': {
    'url': '{chromium_git}/chromium/src/buildtools.git@cb5d17004e71d4551f7669535d54a66912406847',
    'condition': 'not build_with_chromium',
  },
  ...
  'buildtools/third_party/libc++/trunk': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libcxx.git@ab37483b426c16ce33f8f0064be571513d5a8c34',
    'condition': 'not build_with_chromium',
  },

  'buildtools/third_party/libc++abi/trunk': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libcxxabi.git@4a9d0560b481a96821bec591325b50a5063f4a32',
    'condition': 'not build_with_chromium',
  },

  'buildtools/third_party/libunwind/trunk': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libunwind.git@f3464caa6aa83a5eb924a5ae3779e974bd1bebf4',
    'condition': 'not build_with_chromium',
  },
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@124d121ec0c2750ca21ffcaac7eafb89acc6268a',
    'condition': 'not build_with_chromium',
  },

  'third_party/abseil-cpp': {
    'url': '{chromium_git}/chromium/src/third_party/abseil-cpp@20c8ae002db022653b94e80dec69306558818ebf',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/android_deps': {
    'url': '{chromium_git}/chromium/src/third_party/android_deps@c17c19277217d5f2cfb1ead20235bd2df092ab36',
    'condition': 'checkout_android and not build_with_chromium',
  },
  ...
  'third_party/android_platform': {
    'url': '{chromium_git}/chromium/src/third_party/android_platform@ed245f0bcbb45db31ab92345faaef5957942295d',
    'condition': 'checkout_android and not build_with_chromium',
  },
  ...
  'third_party/depot_tools': {
    'url': '{chromium_git}/chromium/tools/depot_tools.git@401f0f6e433c9143bef1ac901f230f82e5f7c180',
    'condition': 'not build_with_chromium',
  },
      ...
      'packages': [
          {
              ...
              'version': 'GcQ-oelMmVQMKFpvjCNroGxPCOnapQAHbIqjjSymmCAC',
          },
      ],
      'condition': 'checkout_android and not build_with_chromium',
      'dep_type': 'cipd',
  ...
  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@e671d7c87d3b933bade4fe46c52bff081b7af757',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/zlib': {
    'url': '{chromium_git}/chromium/src/third_party/zlib@5edb52d4302d7aef232d585ec9ae27ef5c3c5438',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/clang': {
    'url': '{chromium_git}/chromium/src/tools/clang.git@f6862472607fa628642713b615a9e119d51bd43d',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/mb': {
    'url': '{chromium_git}/chromium/src/tools/mb@45fb5a967feac6c595a9694259527709bc0c0464',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': '{chromium_git}/chromium/src/tools/perf@18e0d7aac4ba86fb4c7e35fa21b23243fe6cfcc8',
    'condition': 'not build_with_chromium',
  },
      ...
      'packages': [
        {
          ...
          'version': 'aW-NZ8C8eVMaPmBAILqVE-mOxYdoUXfiDHShsTeZMwkC',
        },
      ],
      'dep_type': 'cipd',
      ...
      'packages': [
        {
          ...
          'version': '432GgeQWQIAz1NADw1ssxRVYDIKzNs1i3tKIITtxDdcC',
        },
      ],
      'dep_type': 'cipd',
      'condition': 'checkout_mac and not build_with_chromium',
  ...
  'third_party/android_deps/libs/net_bytebuddy_byte_buddy_android': {
      'packages': [
          {
