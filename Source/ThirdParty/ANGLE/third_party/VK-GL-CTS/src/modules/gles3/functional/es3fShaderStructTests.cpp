...
#define LOCAL_STRUCT_CASE(NAME, DESCRIPTION, SHADER_SRC, EVAL_FUNC_BODY) \
    ...
    LOCAL_STRUCT_CASE(
        nested_struct_array_dynamic_index, "Nested struct array with dynamic indexing",
        LineStream() << "${HEADER}"
                     << "uniform int ui_zero;"
                     << "uniform int ui_one;"
                     << "uniform int ui_two;"
    ...
    LOCAL_STRUCT_CASE_PARAMETERIZED(
        parameter_inout_lowp, "Struct with lowp members as an inout function parameter", inoutSrc,
        { c.color.xyz() = tcu::Vec3(1.0, 1.0, 1.0); }, &precisionParams);

    precisionParams["PRECISION"] = "mediump";
    LOCAL_STRUCT_CASE_PARAMETERIZED(
        parameter_inout_mediump, "Struct with mediump members as an inout function parameter", inoutSrc,
        { c.color.xyz() = tcu::Vec3(1.0, 1.0, 1.0); }, &precisionParams);

    precisionParams["PRECISION"] = "highp";
    LOCAL_STRUCT_CASE_PARAMETERIZED(
        parameter_inout_highp, "Struct with highp members as an inout function parameter", inoutSrc,
        { c.color.xyz() = tcu::Vec3(1.0, 1.0, 1.0); }, &precisionParams);
    ...
    precisionParams["PRECISION"] = "lowp";
    LOCAL_STRUCT_CASE_PARAMETERIZED(
        parameter_out_lowp, "Struct with lowp members as an out function parameter", outSrc,
        { c.color.xyz() = tcu::Vec3(1.0, 1.0, 1.0); }, &precisionParams);

    precisionParams["PRECISION"] = "mediump";
    LOCAL_STRUCT_CASE_PARAMETERIZED(
        parameter_out_mediump, "Struct with mediump members as an out function parameter", outSrc,
        { c.color.xyz() = tcu::Vec3(1.0, 1.0, 1.0); }, &precisionParams);

    precisionParams["PRECISION"] = "highp";
    LOCAL_STRUCT_CASE_PARAMETERIZED(
        parameter_out_highp, "Struct with highp members as an out function parameter", outSrc,
        { c.color.xyz() = tcu::Vec3(1.0, 1.0, 1.0); }, &precisionParams);
...
#define UNIFORM_STRUCT_CASE(NAME, DESCRIPTION, TEXTURES, SHADER_SRC, SET_UNIFORMS_BODY, EVAL_FUNC_BODY)             \
    ...
    UNIFORM_STRUCT_CASE(
        not_equal, "Struct equality", false,
        LineStream() << "${HEADER}"
                     << "uniform mediump float uf_one;"
                     << "uniform int ui_two;"
                     << ""
