...
ANGLE_TRACE_LOADER_EXPORT PFNGLFRAMEBUFFERMTLRASTERIZATIONRATEMAPANGLEPROC
    t_glFramebufferMTLRasterizationRateMapANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLGETFRAMEBUFFERMTLRASTERIZATIONRATEMAPANGLEPROC
    t_glGetFramebufferMTLRasterizationRateMapANGLE;
...
void LoadTraceGLES(LoadProc loadProc)
{
    ...
    t_glFramebufferMTLRasterizationRateMapANGLE =
        reinterpret_cast<PFNGLFRAMEBUFFERMTLRASTERIZATIONRATEMAPANGLEPROC>(
            loadProc("glFramebufferMTLRasterizationRateMapANGLE"));
    t_glGetFramebufferMTLRasterizationRateMapANGLE =
        reinterpret_cast<PFNGLGETFRAMEBUFFERMTLRASTERIZATIONRATEMAPANGLEPROC>(
            loadProc("glGetFramebufferMTLRasterizationRateMapANGLE"));
