...
void vpx_fdct32x32_rd_c(const int16_t* input,
                           tran_low_t* output,
                           int stride);
...
uint32_t vpx_highbd_8_sub_pixel_avg_variance8x4_c(const uint8_t* src_ptr,
                                                  ...
                                                  uint32_t* sse,
                                                  const uint8_t* second_pred);
uint32_t vpx_highbd_8_sub_pixel_avg_variance8x4_c(
    const uint8_t* src_ptr,
    int source_stride,
    int xoffset,
    int yoffset,
...
uint32_t vpx_highbd_8_sub_pixel_avg_variance8x8_c(const uint8_t* src_ptr,
                                                  ...
                                                  uint32_t* sse,
                                                  const uint8_t* second_pred);
uint32_t vpx_highbd_8_sub_pixel_avg_variance8x8_c(
    const uint8_t* src_ptr,
    int source_stride,
    int xoffset,
    int yoffset,
...
void vpx_idct16x16_10_add_c(const tran_low_t* input,
                               uint8_t* dest,
                               int stride);
#define vpx_idct16x16_10_add vpx_idct16x16_10_add_c

void vpx_idct16x16_1_add_c(const tran_low_t* input, uint8_t* dest, int stride);
void vpx_idct16x16_1_add_c(const tran_low_t* input,
                              uint8_t* dest,
                              int stride);
...
void vpx_idct16x16_38_add_c(const tran_low_t* input,
                               uint8_t* dest,
                               int stride);
...
void vpx_idct32x32_1_add_c(const tran_low_t* input,
                              uint8_t* dest,
                              int stride);
#define vpx_idct32x32_1_add vpx_idct32x32_1_add_c

void vpx_idct32x32_34_add_c(const tran_low_t* input, uint8_t* dest, int stride);
void vpx_idct32x32_34_add_c(const tran_low_t* input,
                               uint8_t* dest,
                               int stride);
...
void vpx_idct4x4_16_add_c(const tran_low_t* input,
                             uint8_t* dest,
                             int stride);
...
void vpx_idct8x8_12_add_c(const tran_low_t* input,
                             uint8_t* dest,
                             int stride);
...
void vpx_idct8x8_64_add_c(const tran_low_t* input,
                             uint8_t* dest,
                             int stride);
...
void vpx_iwht4x4_16_add_c(const tran_low_t* input,
                             uint8_t* dest,
                             int stride);
