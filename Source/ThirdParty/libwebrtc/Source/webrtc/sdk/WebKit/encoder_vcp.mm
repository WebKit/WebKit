...
#include "webrtc/sdk/WebKit/encoder_vcp.h"
...
// of time.
H264VideoToolboxEncoderVCP::H264VideoToolboxEncoderVCP(const webrtc::SdpVideoFormat& format, VideoToolboxVideoEncoderFactory& factory)
    : callback_(nullptr),
