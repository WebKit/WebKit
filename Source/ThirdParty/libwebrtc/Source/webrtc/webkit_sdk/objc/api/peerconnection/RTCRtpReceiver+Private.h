...
@property(nonatomic, readonly) webrtc::scoped_refptr<webrtc::RtpReceiverInterface> nativeRtpReceiver;

/** Initialize an RTCRtpReceiver with a native RtpReceiverInterface. */
- (instancetype)initWithFactory:(RTCPeerConnectionFactory*)factory
              nativeRtpReceiver:(webrtc::scoped_refptr<webrtc::RtpReceiverInterface>)nativeRtpReceiver
