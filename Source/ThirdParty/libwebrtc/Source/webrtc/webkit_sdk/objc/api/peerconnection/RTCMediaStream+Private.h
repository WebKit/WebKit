 ...
 */
@property(nonatomic, readonly) webrtc::scoped_refptr<webrtc::MediaStreamInterface> nativeMediaStream;
...
- (instancetype)initWithFactory:(RTCPeerConnectionFactory *)factory
              nativeMediaStream:(webrtc::scoped_refptr<webrtc::MediaStreamInterface>)nativeMediaStream;
