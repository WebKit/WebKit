...
TEST(PeerConnectionE2EQualityTestMetricNamesTest,
  ...
  EXPECT_THAT(
      ...
      UnorderedElementsAre(
          ...
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("alice_audio"),
              .name = "expand_rate",
              .unit = Unit::kUnitless,
          ...
          MetricValidationInfo{
              ...
              .metadata = {{MetricMetadataKey::kAudioStreamMetadataKey,
                           ...
                           {MetricMetadataKey::kReceiverMetadataKey, "bob"}}},
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("bob_audio"),
              .name = "expand_rate",
              .unit = Unit::kUnitless,
              .improvement_direction = ImprovementDirection::kSmallerIsBetter,
              .metadata = {{MetricMetadataKey::kAudioStreamMetadataKey,
          ...
          MetricValidationInfo{
              ...
              .metadata = {{MetricMetadataKey::kPeerMetadataKey, "alice"},
                           ...
                           {MetricMetadataKey::kReceiverMetadataKey, "bob"}}},
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("bob_video"),
              .name = "psnr_dB",
              .unit = Unit::kUnitless,
              .improvement_direction = ImprovementDirection::kBiggerIsBetter,
              .metadata = {{MetricMetadataKey::kPeerMetadataKey, "bob"},
          ...
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("alice"),
          ...
          MetricValidationInfo{
              ...
              .metadata = {{MetricMetadataKey::kPeerMetadataKey, "alice"}}},
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("bob"),
              .name = "bytes_discarded_no_receiver",
              .unit = Unit::kBytes,
              .improvement_direction = ImprovementDirection::kNeitherIsBetter,
              .metadata = {{MetricMetadataKey::kPeerMetadataKey, "bob"}}},
          ...
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("alice_alice_audio"),
              .name = "audio_ahead_ms",
              .unit = Unit::kMilliseconds,
              .improvement_direction = ImprovementDirection::kSmallerIsBetter,
              .metadata =
                  {{MetricMetadataKey::kAudioStreamMetadataKey, "alice_audio"},
                   ...
                   {MetricMetadataKey::kReceiverMetadataKey, "bob"}}},
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("alice_alice_video"),
              .name = "video_ahead_ms",
              .unit = Unit::kMilliseconds,
              .improvement_direction = ImprovementDirection::kSmallerIsBetter,
              .metadata =
                  {{MetricMetadataKey::kAudioStreamMetadataKey, "alice_video"},
                   ...
                   {MetricMetadataKey::kReceiverMetadataKey, "bob"}}},
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("bob_bob_audio"),
              .name = "audio_ahead_ms",
              .unit = Unit::kMilliseconds,
              .improvement_direction = ImprovementDirection::kSmallerIsBetter,
              .metadata =
                  {{MetricMetadataKey::kAudioStreamMetadataKey, "bob_audio"},
                   ...
                   {MetricMetadataKey::kReceiverMetadataKey, "alice"}}},
          MetricValidationInfo{
              .test_case = GetExpectedTestCaseName("bob_bob_video"),
              .name = "video_ahead_ms",
              .unit = Unit::kMilliseconds,
              .improvement_direction = ImprovementDirection::kSmallerIsBetter,
              .metadata =
