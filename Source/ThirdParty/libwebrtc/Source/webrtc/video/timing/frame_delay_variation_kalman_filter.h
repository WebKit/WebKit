...
#ifndef VIDEO_TIMING_FRAME_DELAY_VARIATION_KALMAN_FILTER_H_
#define VIDEO_TIMING_FRAME_DELAY_VARIATION_KALMAN_FILTER_H_
...
#endif  // VIDEO_TIMING_FRAME_DELAY_VARIATION_KALMAN_FILTER_H_
