...
install:
    ...
    set ProgramFilesAAS=$(SRCROOT)\Program Files (x86)\Common Files\Apple\Apple Application Support
	...
	xcopy "%ConfigurationBuildDir%\bin32\*.pdb" "%ProgramFilesAAS%" /e/v/i/h/y
	-xcopy "%ConfigurationBuildDir%\bin32\*.dll" "%ProgramFilesAAS%" /e/v/i/h/y
	xcopy "%ConfigurationBuildDir%\include\*" "$(DSTROOT)\AppleInternal\include\" /e/v/i/h/y	
	xcopy "%ConfigurationBuildDir%\lib32\*" "$(DSTROOT)\AppleInternal\lib32\" /e/v/i/h/y
	xcopy "%ConfigurationBuildDir%\bin32\WebKit.resources\*" "%ProgramFilesAAS%\WebKit.resources" /e/v/i/h/y
