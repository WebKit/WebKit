...
const ASCIICString& webKitURISchemeResponseGetStatusMessage(const WebKitURISchemeResponse*);
const ASCIICString& webKitURISchemeResponseGetContentType(const WebKitURISchemeResponse*);
