 ...
 *
 * Construct it using webkit_user_agent_new() or webkit_user_agent_new_with_application_details(),
...
WTF_MAKE_STRUCT_TZONE_ALLOCATED_IMPL(_WebKitUserAgent);
...
/**
 * webkit_user_agent_new_with_application_details: (constructor)
 * @type: a #WebKitUserAgentType
 ...
 * Since: 2.56
 */
WebKitUserAgent* webkit_user_agent_new_with_application_details(WebKitUserAgentType type, const gchar* applicationName, const gchar* applicationVersion)
{
