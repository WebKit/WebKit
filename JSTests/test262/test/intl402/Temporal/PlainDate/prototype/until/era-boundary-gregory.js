...
const bce5 = Temporal.PlainDate.from({ era: "bce", eraYear: 5, monthCode: "M06", day: 15, calendar }, options);
const bce2 = Temporal.PlainDate.from({ era: "bce", eraYear: 2, monthCode: "M12", day: 1, calendar }, options);
const bce1 = Temporal.PlainDate.from({ era: "bce", eraYear: 1, monthCode: "M06", day: 15, calendar }, options);
const ce1 = Temporal.PlainDate.from({ era: "ce", eraYear: 1, monthCode: "M06", day: 15, calendar }, options);
const ce2 = Temporal.PlainDate.from({ era: "ce", eraYear: 2, monthCode: "M01", day: 1, calendar }, options);
const ce5 = Temporal.PlainDate.from({ era: "ce", eraYear: 5, monthCode: "M06", day: 15, calendar }, options);
