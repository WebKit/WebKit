...
TemporalHelpers.assertPlainDate(
  date19200716.subtract(years1),
  1921, 7, "M07", 16, "add 1y",
  "shaka", 1921);
TemporalHelpers.assertPlainDate(
  date19200716.subtract(years4),
  1924, 7, "M07", 16, "add 4y",
  "shaka", 1924);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(years1n),
  1919, 7, "M07", 16, "subtract 1y",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  date19200716.subtract(years4n),
...
TemporalHelpers.assertPlainDate(
  date19200716.subtract(months5),
  1920, 12, "M12", 16, "add 5mo with result in the same year",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M08", day: 16, calendar }).subtract(months5),
  1921, 1, "M01", 16, "add 5mo with result in the next year",
  "shaka", 1921);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1918, monthCode: "M10", day: 1, calendar }).subtract(months5),
  1919, 3, "M03", 1, "add 5mo with result in the next year on day 1 of month",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M06", day: 31, calendar }).subtract(months8),
  1921, 2, "M02", 31, "add 8mo with result in the next year on day 31 of month",
  "shaka", 1921);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(years1months2),
  1921, 9, "M09", 16, "add 1y 2mo",
  "shaka", 1921);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M11", day: 30, calendar }).subtract(years1months2),
  1922, 1, "M01", 30, "add 1y 2mo with result in the next year",
  "shaka", 1922);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(months5n),
  1920, 2, "M02", 16, "subtract 5mo with result in the same year",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M01", day: 16, calendar }).subtract(months5n),
  1919, 8, "M08", 16, "subtract 5mo with result in the previous year",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1918, monthCode: "M02", day: 1, calendar }).subtract(months5n),
  1917, 9, "M09", 1, "subtract 5mo with result in the previous year on day 1 of month",
  "shaka", 1917);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M02", day: 31, calendar }).subtract(months8n),
  1919, 6, "M06", 31, "subtract 8mo with result in the previous year on day 31 of month",
  "shaka", 1919);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(years1months2n),
  1919, 5, "M05", 16, "subtract 1y 2mo",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M02", day: 17, calendar }).subtract(years1months2n),
...
TemporalHelpers.assertPlainDate(
  ...
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  date19200527.subtract(weeks6),
  1920, 7, "M07", 7, "add 6w crossing months of 31 and 31 days",
  "shaka", 1920);

TemporalHelpers.assertPlainDate(
  date19201228.subtract(years1weeks2),
  1922, 1, "M01", 12, "add 1y 2w with result in the next year",
  "shaka", 1922);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1918, monthCode: "M10", day: 28, calendar }).subtract(months2weeks3),
  1919, 1, "M01", 19, "add 2mo 3w with result in the next year",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1918, monthCode: "M10", day: 31, calendar }).subtract(months2weeks3),
  1919, 1, "M01", 21, "add 2mo 3w with result in the next year",
  "shaka", 1919);

TemporalHelpers.assertPlainDate(
  date19200219.subtract(weeks1n),
  1920, 2, "M02", 12, "subtract 1w",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M01", day: 8, calendar }).subtract(weeks1n),
  1920, 1, "M01", 1, "subtract 1w with result on the first day of the year",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M01", day: 7, calendar }).subtract(weeks1n),
  1919, 12, "M12", 30, "subtract 1w with result on the last day of the previous year",
  "shaka", 1919);

TemporalHelpers.assertPlainDate(
  date19200704.subtract(weeks1n),
  1920, 6, "M06", 28, "subtract 1w with result in the previous 31-day month",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M02", day: 3, calendar }).subtract(weeks1n),
  1920, 1, "M01", 26, "subtract 1w with result in the previous 30-day month",
  "shaka", 1920);

TemporalHelpers.assertPlainDate(
  date19200604.subtract(weeks6n),
  1920, 4, "M04", 24, "subtract 6w with result in the same year",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  date19200127.subtract(weeks6n),
  1919, 12, "M12", 15, "subtract 6w with result in the previous year",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M07", day: 8, calendar }).subtract(weeks6n),
  1920, 5, "M05", 28, "subtract 6w crossing months of 30 and 31 days",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M03", day: 8, calendar }).subtract(weeks6n),
  1920, 1, "M01", 27, "subtract 6w crossing months of 31 and 31 days",
  "shaka", 1920);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1921, monthCode: "M01", day: 5, calendar }).subtract(years1weeks2n),
  1919, 12, "M12", 21, "subtract 1y 2w with result in the previous year",
  "shaka", 1919);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1918, monthCode: "M03", day: 2, calendar }).subtract(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  date19200716.subtract(days10),
  1920, 7, "M07", 26, "add 10 days with result in the same month",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M07", day: 26, calendar }).subtract(days10),
  1920, 8, "M08", 6, "add 10 days with result in the next month",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M12", day: 26, calendar }).subtract(days10),
  1921, 1, "M01", 6, "add 10 days with result in the next year",
  "shaka", 1921);

TemporalHelpers.assertPlainDate(
  date19201228.subtract(weeks2days3),
  1921, 1, "M01", 15, "add 2w 3d with result in the next year",
  "shaka", 1921);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(years1months2days4),
  1921, 9, "M09", 20, "add 1y 2mo 4d",
  "shaka", 1921);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M11", day: 30, calendar }).subtract(years1months2days4),
  1922, 2, "M02", 3, "add 1y 2mo 4d with result in a month following a 30-day month",
  "shaka", 1922);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M05", day: 26, calendar }).subtract(years1months2days4),
  1921, 7, "M07", 30, "add 1y 2mo 4d with result in a month following a 31-day month",
  "shaka", 1921);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(days10n),
  1920, 7, "M07", 6, "subtract 10 days with result in the same month",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1920, monthCode: "M07", day: 6, calendar }).subtract(days10n),
  1920, 6, "M06", 27, "subtract 10 days with result in the previous month",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1921, monthCode: "M01", day: 4, calendar }).subtract(days10n),
  1920, 12, "M12", 24, "subtract 10 days with result in the previous year",
  "shaka", 1920);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1921, monthCode: "M01", day: 15, calendar }).subtract(weeks2days3n),
  1920, 12, "M12", 28, "subtract 2w 3d with result in the previous year",
  "shaka", 1920);

TemporalHelpers.assertPlainDate(
  date19200716.subtract(years1months2days4n),
  1919, 5, "M05", 12, "subtract 1y 2mo 4d",
  "shaka", 1919);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1921, monthCode: "M12", day: 4, calendar }).subtract(years1months2days4n),
  1920, 9, "M09", 30, "subtract 1y 2mo 4d with result in a 30-day month",
  "shaka", 1920);
TemporalHelpers.assertPlainDate(
  date19200604.subtract(years1months2days4n),
