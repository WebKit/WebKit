...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 5782, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).add(months2weeks3),
  5783, 3, "M03", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year",
  "am", 5783
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 5782, monthCode: "M10", day: 1, hour: 12, minute: 34, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 5782, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).add(days10),
