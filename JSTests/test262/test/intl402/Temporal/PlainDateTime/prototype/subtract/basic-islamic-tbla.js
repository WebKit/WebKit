...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1445, monthCode: "M06", day: 15, hour: 12, minute: 34, calendar }).subtract(new Temporal.Duration(0, -13)),
  1446, 7, "M07", 15, 12, 34, 0, 0, 0, 0, "Adding 13 months to Jumada II 1445 lands in Rajab 1446",
  "ah", 1446
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1445, monthCode: "M03", day: 15, hour: 12, minute: 34, calendar }, options).subtract(new Temporal.Duration(0, -6)),
  1445, 9, "M09", 15, 12, 34, 0, 0, 0, 0, "Adding 6 months to Rabi I 1445 lands in Ramadan",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1444, monthCode: "M10", day: 1, hour: 12, minute: 34, calendar }).subtract(new Temporal.Duration(0, -5)),
  1445, 3, "M03", 1, 12, 34, 0, 0, 0, 0, "Adding 5 months to Shawwal 1444 crosses to 1445",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1400, monthCode: "M01", day: 1, hour: 12, minute: 34, calendar }).subtract(new Temporal.Duration(0, -100)),
  1408, 5, "M05", 1, 12, 34, 0, 0, 0, 0, "Adding a large number of months",
  "ah", 1408
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1445, monthCode: "M09", day: 1, hour: 12, minute: 34, calendar }, options).subtract(new Temporal.Duration(0, 8)),
  1445, 1, "M01", 1, 12, 34, 0, 0, 0, 0, "Subtracting 8 months from Ramadan 1445 lands in Muharram",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1445, monthCode: "M06", day: 1, hour: 12, minute: 34, calendar }, options).subtract(new Temporal.Duration(0, 12)),
  1444, 6, "M06", 1, 12, 34, 0, 0, 0, 0, "Subtracting 12 months from Jumada II 1445 lands in Jumada II 1444",
  "ah", 1444
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1445, monthCode: "M02", day: 15, hour: 12, minute: 34, calendar }, options).subtract(new Temporal.Duration(0, 5)),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1441, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3),
  1442, 3, "M03", 21, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year",
  "ah", 1442
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1441, monthCode: "M10", day: 1, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1440, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).subtract(days10),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1439, monthCode: "M06", day: 1, hour: 12, minute: 34, calendar }, options).subtract(days10n),
