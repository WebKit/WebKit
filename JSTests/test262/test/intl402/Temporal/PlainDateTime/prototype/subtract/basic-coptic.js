...
const date174202 = Temporal.PlainDateTime.from({ year: 1742, monthCode: "M02", day: 1, hour: 12, minute: 34, calendar }, options);
const date174702 = Temporal.PlainDateTime.from({ year: 1747, monthCode: "M02", day: 29, hour: 12, minute: 34, calendar }, options);
...
const date174301 = Temporal.PlainDateTime.from({ year: 1743, monthCode: "M01", day: 1, hour: 12, minute: 34, calendar }, options);
const date174306 = Temporal.PlainDateTime.from({ year: 1743, monthCode: "M06", day: 1, hour: 12, minute: 34, calendar }, options);
const date174311 = Temporal.PlainDateTime.from({ year: 1743, monthCode: "M11", day: 1, hour: 12, minute: 34, calendar }, options);
const date174213 = Temporal.PlainDateTime.from({ year: 1742, monthCode: "M13", day: 1, hour: 12, minute: 34, calendar }, options);
...
TemporalHelpers.assertPlainDateTime(
  date174401.subtract(months2weeks3),
  1744, 3, "M03", 22, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from non-leap day/month, ending in same year", "am", 1744
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1744, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3),
  1745, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year", "am", 1745
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1744, monthCode: "M06", day: 1, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3n),
  1744, 3, "M03", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from non-leap day/month, ending in same year", "am", 1744
);

TemporalHelpers.assertPlainDateTime(
  date174401.subtract(months2weeks3n),
