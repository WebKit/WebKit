...
TemporalHelpers.assertPlainDateTime(
  date144501.subtract(new Temporal.Duration(0, -8)).toPlainDateTime(),
  1445, 9, "M09", 1, 12, 34, 0, 0, 0, 0, "Adding 8 months to Muharram 1445 lands in Ramadan",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  date144501.subtract(new Temporal.Duration(0, -11)).toPlainDateTime(),
  1445, 12, "M12", 1, 12, 34, 0, 0, 0, 0, "Adding 11 months to Muharram 1445 lands in Dhu al-Hijjah",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  date144501.subtract(new Temporal.Duration(0, -12)).toPlainDateTime(),
