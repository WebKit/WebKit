var wasm_code = read('operand-stack-test.wasm', 'binary');
...
let run = instance.exports.entry;

// A constant argument, so every value at a breakpoint is invariant and a wrong reading is
// unambiguously wrong.
