...
class Logger:
    ...
    def _should_show_in_quiet_mode(cls, msg: str) -> bool:
        ...
        important_keywords = ["✅ PASSED", "❌ FAILED", "Total tests:", "Passed:", "Failed:",
                             "Total test execution time:", "Wall clock time:", "Parallelization speedup:",
                             "Parallel efficiency:", "🎉", "📊", "Starting Parallel", "Summary"]
    ...
    def verbose(cls, msg: str):
        ...
        if cls._verbose:
            if cls._enable_pid_tid:
                ...
                original_stdout.write(f"{Colors.DIM}🔍 [FRAMEWORK] {msg}{Colors.RESET}\n")
