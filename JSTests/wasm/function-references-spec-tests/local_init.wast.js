...
// local_init.wast:21
//assert_return(() => call($1, "get-after-set", [externref(1)]), externref(1));

// local_init.wast:22
//assert_return(() => call($1, "get-after-tee", [externref(2)]), externref(2));

// local_init.wast:23
//assert_return(() => call($1, "get-in-block-after-set", [externref(3)]), externref(3));
