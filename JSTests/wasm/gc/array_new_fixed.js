...
(module
  ...
  (func $new (export "new") (result (ref $vec))
    ...
    assert.throws(() => new WebAssembly.Instance(module("")), WebAssembly.CompileError, "WebAssembly.Module doesn't parse at byte 56: parsing ended before the end of Code section");
