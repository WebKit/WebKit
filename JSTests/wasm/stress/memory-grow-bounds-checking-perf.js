...
function assertDestroyWhenInitialEqualsMaximum() {
...
function assertOOBAfterPartialGrow() {
    ...
    assert.throws(() => instance.exports.get(2 * 65536), WebAssembly.RuntimeError, "Out of bounds");
...
assertDestroyWhenInitialEqualsMaximum();
