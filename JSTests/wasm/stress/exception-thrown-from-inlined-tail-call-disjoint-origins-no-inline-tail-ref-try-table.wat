;; wat2wasm JSTests/wasm/stress/exception-thrown-from-inlined-tail-call-disjoint-origins-no-inline-tail-ref-try-table.wat -o JSTests/wasm/stress/exception-thrown-from-inlined-tail-call-disjoint-origins-no-inline-tail-ref-try-table.wasm --enable-all --debug-names
(module
    (tag $tag0)
    (tag $tag1)
    (tag $tag1b)
