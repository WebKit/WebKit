...
// Covers every IPInt cmpxchg opcode with offset < 128, so loadStoreMakePointerFast takes its fast
// path. Which compare-and-swap that reaches is decided at build time: plain ARM64 calls the
// out-of-line load-linked/store-conditional helpers, ARM64E and X86_64 use a hardware CAS.
let wat = `
(module
  (memory 1 1 shared)
