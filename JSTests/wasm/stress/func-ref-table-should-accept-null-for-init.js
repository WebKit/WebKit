...
const v9 = builder.addTable(kWasmFuncRef, 10);
const v31 = builder.addGlobal(kWasmFuncRef);
builder.addActiveElementSegment(v9.index, wasmI32Const(0), [[kExprGlobalGet,v31.index]], kWasmFuncRef);
builder.instantiate();