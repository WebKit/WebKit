;; wat2wasm JSTests/wasm/stress/exception-thrown-from-inlined-tail-call-disjoint-origins-multiple-tail-calls-indirect.wat -o JSTests/wasm/stress/exception-thrown-from-inlined-tail-call-disjoint-origins-multiple-tail-calls-indirect.wasm --enable-all --debug-names
(module
    (tag $tag0)
    (tag $tag0b)
    (tag $tag1)
