...
var wasm_code = read('exception-thrown-from-inlined-tail-call-disjoint-origins-stack-trace-no-inline-tail.wasm', 'binary')
...
const msg = ["throw0@wasm-function[1];b@wasm-function[7];test@wasm-function[24]","throw1@wasm-function[2];do_tail_b@wasm-function[23];test@wasm-function[24]","throw2@wasm-function[3];test@wasm-function[24]","throw3@wasm-function[4];a@wasm-function[6];test@wasm-function[24]","throw4@wasm-function[5];do_tail_a@wasm-function[22];test@wasm-function[24]"]
