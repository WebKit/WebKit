...
async function testCatchAndResuspend() {
  ...
  b.Type().End()
      .Import()
          .Function("env", "throwingFunc", { params: [], ret: "i32" })
          .Function("env", "returningFunc", { params: [], ret: "i32" })
      .End()
      .Function().End()
      .Exception().Signature({ params: ["i32"] }).End()
      .Export()
          .Function("testCatchAndResuspend")
          .Exception("tag", 0)
      .End()
      .Code()
          .Function("testCatchAndResuspend", { params: [], ret: "i32" })
              .Try("i32")
                  .Call(0)
                  .Drop()
                  .I32Const(999)
...
async function testCatchAndThrowAgain() {
  ...
  b.Type().End()
      .Import()
          .Function("env", "throwingFunc", { params: [], ret: "i32" })
          .Function("env", "secondThrowingFunc", { params: [], ret: "i32" })
      .End()
      .Function().End()
      .Exception().Signature({ params: ["i32"] }).End()
      .Export()
          .Function("testCatchTwoExceptions")
          .Exception("tag", 0)
      .End()
      .Code()
          .Function("testCatchTwoExceptions", { params: [], ret: "i32" })
              .Try("i32")
                  .Call(0)
                  .Drop()
                  .I32Const(999)
