...
function invalidTableInitUnreachable() {
  ...
  */
  ...
  "WebAssembly.Module doesn't validate: table index 11 is invalid, limit is 1, in function at index 1");
}
...
function invalidTableSizeUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x04\x04\x01\x70\x00\x0a\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x09\x01\x07\x00\x0f\xfc\x10\x0a\x1a\x0b"),
  "WebAssembly.Module doesn't validate: table index 10 is invalid, limit is 1, in function at index 0");
}
...
function invalidElemDropUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes(""),
  "WebAssembly.Module doesn't validate: element index 10 is invalid, limit is 1, in function at index 2");
}
...
function invalidTableGrowUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x04\x04\x01\x70\x00\x0a\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x0b\x01\x09\x00\x0f\x41\x25\xfc\x0f\x0a\x1a\x0b"),
  "WebAssembly.Module doesn't validate: table index 10 is invalid, limit is 1, in function at index 0");
}
...
function invalidTableFillUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x04\x04\x01\x70\x00\x0a\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x0e\x01\x0c\x00\x0f\x41\x00\xd0\x70\x41\x07\xfc\x11\x0a\x0b"),
  "WebAssembly.Module doesn't validate: table index 10 is invalid, limit is 1, in function at index 0");
}
...
function invalidTableCopyUnreachable() {
  ...
  */
  ...
  "WebAssembly.Module doesn't validate: table index 10 is invalid, limit is 2, in function at index 2");
}
...
function invalidAnnotatedSelectUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x04\x04\x01\x6f\x00\x0a\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x0f\x01\x0d\x00\x0f\xd0\x6f\xd0\x6f\x41\x01\x1c\x02\x6f\x1a\x0b"),
  "WebAssembly.Module doesn't parse at byte 10: select invalid result arity for, in function at index 0");
}
...
function invalidMemoryFillUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x05\x03\x01\x00\x01\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x0e\x01\x0c\x00\x0f\x41\x00\x41\x0b\x41\x03\xfc\x0b\x01\x0b"),
  "WebAssembly.Module doesn't validate: memory index 1 is out of range, in function at index 0");
}
...
function invalidMemoryCopyUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x05\x03\x01\x00\x01\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x0f\x01\x0d\x00\x0f\x41\x03\x41\x00\x41\x01\xfc\x0a\x01\x00\x0b"),
  "WebAssembly.Module doesn't validate: memory index 1 is out of range, in function at index 0");
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x05\x03\x01\x00\x01\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0a\x0f\x01\x0d\x00\x0f\x41\x03\x41\x00\x41\x01\xfc\x0a\x00\x01\x0b"),
  "WebAssembly.Module doesn't validate: memory index 1 is out of range, in function at index 0");
}
...
function invalidMemoryInitUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x05\x03\x01\x00\x01\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0c\x01\x01\x0a\x0f\x01\x0d\x00\x0f\x41\x04\x41\x00\x41\x04\xfc\x08\x0a\x00\x0b\x0b\x07\x01\x01\x04\x02\x03\x05\x07"),
  "WebAssembly.Module doesn't validate: data segment index 10 is invalid, limit is 1, in function at index 0");
}
...
function invalidDataDropUnreachable() {
  ...
  */
  assert.compileError(assert.stringToBytes("\x00\x61\x73\x6d\x01\x00\x00\x00\x01\x04\x01\x60\x00\x00\x03\x02\x01\x00\x05\x03\x01\x00\x01\x07\x07\x01\x03\x72\x75\x6e\x00\x00\x0c\x01\x01\x0a\x08\x01\x06\x00\x0f\xfc\x09\x0a\x0b\x0b\x04\x01\x01\x01\x37"),
  "WebAssembly.Module doesn't validate: data segment index 10 is invalid, limit is 1, in function at index 0");
}
