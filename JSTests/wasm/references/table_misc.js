...
assert.compileError((new Builder())
      ...
      .Code()
        .Function("tbl_size", { params: [], ret: "i32" })
          .TableSize(0)
        .End()
      .End().WebAssembly().get(), "WebAssembly.Module doesn't validate: table index 0 is invalid, limit is 0, in function at index 0")
...
assert.compileError((new Builder())
      ...
      .Code()
        .Function("tbl_grow", { params: ["externref", "i32"], ret: "i32" })
            ...
            .TableGrow(0)
        .End()
      .End().WebAssembly().get(), "WebAssembly.Module doesn't parse at byte 6: can't pop empty stack in table.grow, in function at index 0")
...
assert.compileError((new Builder())
      ...
      .Code()
        .Function("tbl_grow", { params: ["i32", "i32"], ret: "i32" })
            ...
            .TableGrow(0)
        .End()
      .End().WebAssembly().get(), `WebAssembly.Module doesn't validate: table.grow expects fill value of type (ref null extern) got I32, in function at index 0`)
...
assert.compileError((new Builder())
      ...
      .Code()
        .Function("tbl_grow", { params: ["externref", "i32"], ret: "i32" })
            ...
            .TableFill(0)
        .End()
      .End().WebAssembly().get(), "WebAssembly.Module doesn't parse at byte 6: can't pop empty stack in table.fill, in function at index 0")
