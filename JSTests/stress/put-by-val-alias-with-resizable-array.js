//@ runDefault("--thresholdForJITAfterWarmUp=10", "--thresholdForOptimizeAfterWarmUp=100", "--thresholdForFTLOptimizeAfterWarmUp=1000", "--useConcurrentJIT=false")
...
bytes.sort(function () {
    a++;
    bytes.slice().findIndex(function () {
        bytes[a] ^= a;
    });
    bytes[bytes[114]] = a;
    return false;
