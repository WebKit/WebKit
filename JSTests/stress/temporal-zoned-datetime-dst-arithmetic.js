...
// temporal-zdt-dst-arithmetic.js — ZDT arithmetic across DST boundaries
// Regression test for day-correction loop bug

function shouldBe(a, b, msg) {
    if (a !== b) throw new Error(`${msg}: expected ${b}, got ${a}`);
}

// Adding 1 day across spring-forward: wall-clock time preserved
{
...
// Adding 1 day across fall-back: wall-clock time preserved
{
...
// hoursInDay: spring-forward day has 23 hours
{
...
// hoursInDay: fall-back day has 25 hours
{
...
// hoursInDay: normal day has 24 hours
{
