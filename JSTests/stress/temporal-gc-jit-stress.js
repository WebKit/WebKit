...
// --- GC pressure: create many PlainDate objects ---
{
    const dates = [];
...
// --- GC pressure: create many Duration objects ---
{
    const durations = [];
    for (let i = 0; i < 10000; i++) {
...
// --- GC pressure: create many ZonedDateTime objects ---
{
    const zdts = [];
...
// --- JIT: hot loop Duration arithmetic ---
{
...
// --- JIT: hot loop Instant comparison ---
{
    const instants = [];
    for (let i = 0; i < 1000; i++) {
