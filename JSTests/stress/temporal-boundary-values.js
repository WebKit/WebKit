...
// --- Epoch nanoseconds boundaries ---
// Valid range: -8.64e21 to 8.64e21 nanoseconds (±100 million days from epoch)
...
// Just beyond max — should throw
{
    shouldThrow(
        () => new Temporal.ZonedDateTime(8640000000000000000001n, "UTC"),
        "Beyond max epoch"
    );
}

// Just beyond min — should throw
{
    shouldThrow(
        () => new Temporal.ZonedDateTime(-8640000000000000000001n, "UTC"),
        "Beyond min epoch"
...
// --- Year boundaries for PlainDate ---
// Valid range: approximately -271821 to 275760
