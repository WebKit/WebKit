...
importFromV3('models/test-parameter', 'TestParameter');
importFromV3('models/test-parameter', 'TestParameterSet');
importFromV3('models/test-parameter', 'CustomTestParameterSet');
