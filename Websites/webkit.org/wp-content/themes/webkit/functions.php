...
/** Workaround to support <dialog> tags by customizing the built-in wpautop() function **/
remove_filter('the_content', 'wpautop');
add_filter('the_content', function ($pee, $br = true) {
/**
 ...
 */
    ...
    $allblocks = '(?:table|thead|tfoot|caption|col|colgroup|tbody|tr|td|th|div|dl|dd|dt|ul|ol|li|pre|form|map|area|blockquote|address|math|style|p|h[1-6]|hr|fieldset|legend|section|article|aside|hgroup|header|footer|nav|figure|figcaption|details|menu|summary|dialog)';
