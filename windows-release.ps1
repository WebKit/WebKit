...
cmake -S . -B $WebKitBuild `
    ...
    "-DCMAKE_C_FLAGS_RELEASE=/Zi /O2 /Ob2 /DNDEBUG -Wl,-force-load" `
    "-DCMAKE_CXX_FLAGS_RELEASE=/Zi /O2 /Ob2 /DNDEBUG  -Xclang -fno-c++-static-destructors -Wl,-force-load" `
    "-DCMAKE_C_FLAGS_DEBUG=/Zi /FS /O0 /Ob0 -Wl,-force-load" `
    "-DCMAKE_CXX_FLAGS_DEBUG=/Zi /FS /O0 /Ob0 -Xclang -fno-c++-static-destructors -Wl,-force-load" `
