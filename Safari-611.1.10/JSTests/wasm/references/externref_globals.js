...
const $1 = new WebAssembly.Instance(new WebAssembly.Module((new Builder())
      .Type().End()
      .Import()
           .Global().Externref("imp", "ref", "immutable").End()
      .End()
      .Function().End()
      .Global()
          .RefNull("externref", "mutable")
          .RefNull("externref", "immutable")
          .GetGlobal("externref", 0, "mutable")
      .End()
      .Export()
          .Function("set_glob")
          .Function("get_glob")
      ...
      .End()
      .Code()
        .Function("set_glob", { params: ["externref"], ret: "void" })
          .GetLocal(0)
          .SetGlobal(1)
        .End()

        .Function("get_glob", { params: [], ret: "externref" })
            .GetGlobal(1)
        .End()
        ...
        .Function("get_import", { params: [], ret: "externref" })
            .GetGlobal(0)
        .End()
