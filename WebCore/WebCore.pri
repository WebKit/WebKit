...
# Enable touch support with Qt 4.6
!lessThan(QT_MINOR_VERSION, 6) {
    DEFINES += ENABLE_TOUCH_EVENTS=1
    DEFINES += ENABLE_TRANSFORMACTION_EVENTS=1
}
...
contains(DEFINES, ENABLE_TRANSFORMACTION_EVENTS=1): FEATURE_DEFINES_JAVASCRIPT += ENABLE_TRANSFORMACTION_EVENTS=1
