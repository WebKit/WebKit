...
bool FrameWin::lastEventIsMouseUp(void)const { notImplemented(); return 0; }
...
bool FrameWin::passSubframeEventToSubframe(WebCore::MouseEventWithHitTestResults &) { notImplemented(); return 0; }
