...
def config_argument_parser():
    ...
    parser.add_argument('--generate-pgo-profiles', '--generate-profiles', dest="generate_pgo_profiles", action='store_true', help="Collect LLVM profiles for PGO, and copy them to the diagnose directory.")
    parser.add_argument('--profile', action='store_true', help="Collect profiling traces for diagnostics.")
