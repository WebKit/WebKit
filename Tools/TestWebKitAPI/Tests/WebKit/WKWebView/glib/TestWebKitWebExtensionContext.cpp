...
static void testDefaultPermissionChecks(Test* test, gconstpointer)
{
    ...
    g_assert_cmpint(webkit_web_extension_context_get_permission_status(context.get(), "tabs"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status(context.get(), "cookies"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://example.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://webkit.org/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://unknown.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    ...
    g_assert_false(webkit_web_extension_context_has_access_to_uri(context.get(), "https://example.com/"));
    g_assert_false(webkit_web_extension_context_has_access_to_uri(context.get(), "https://webkit.org"));
    g_assert_cmpint(webkit_web_extension_context_get_permission_status(context.get(), "tabs"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_REQUESTED_EXPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status(context.get(), "cookies"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://example.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_REQUESTED_EXPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://webkit.org/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://unknown.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_null(webkit_web_extension_context_get_granted_permissions(context.get()));
    g_assert_null(webkit_web_extension_context_get_granted_permission_match_patterns(context.get()));
    ...
    g_assert_cmpint(webkit_web_extension_context_get_permission_status(context.get(), "tabs"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_REQUESTED_EXPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status(context.get(), "cookies"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://example.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_REQUESTED_IMPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://webkit.org/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_REQUESTED_IMPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://unknown.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_REQUESTED_IMPLICITLY);
    g_assert_null(webkit_web_extension_context_get_granted_permissions(context.get()));
    g_assert_null(webkit_web_extension_context_get_granted_permission_match_patterns(context.get()));
    g_assert_null(webkit_web_extension_context_get_denied_permissions(context.get()));
    g_assert_null(webkit_web_extension_context_get_denied_permission_match_patterns(context.get()));
...
static void testPermissionGranting(Test* test, gconstpointer)
{
    ...
    webkit_web_extension_context_set_permission_status(context.get(), "tabs", WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_GRANTED_EXPLICITLY, nullptr);
    ...
    webkit_web_extension_context_set_permission_status(context.get(), "tabs", WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_DENIED_EXPLICITLY, nullptr);
    g_assert_null(webkit_web_extension_context_get_granted_permissions(context.get()));
    ...
    webkit_web_extension_context_set_permission_status(context.get(), "tabs", WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_UNKNOWN, nullptr);
    ...
    g_assert_cmpint(getArraySize(webkit_web_extension_context_get_granted_permission_match_patterns(context.get())), ==, 1);
    g_assert_true(webkit_web_extension_context_has_access_to_uri(context.get(), "https://example.com/"));
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://example.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_GRANTED_IMPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://webkit.org/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_GRANTED_IMPLICITLY);
    ...
    g_assert_cmpint(getArraySize(webkit_web_extension_context_get_denied_permission_match_patterns(context.get())), ==, 1);
    g_assert_false(webkit_web_extension_context_has_access_to_uri(context.get(), "https://example.com/"));
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://example.com/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_DENIED_EXPLICITLY);
    g_assert_cmpint(webkit_web_extension_context_get_permission_status_for_uri(context.get(), "https://webkit.org/"), ==, WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_GRANTED_IMPLICITLY);
    ...
    expirationDate = g_date_time_add_seconds(expirationDate, 1);
    webkit_web_extension_context_set_permission_status(context.get(), "tabs", WEBKIT_WEB_EXTENSION_CONTEXT_PERMISSION_STATUS_GRANTED_EXPLICITLY, expirationDate);
