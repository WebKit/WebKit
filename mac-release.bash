...
CMAKE_C_COMPILER=${CMAKE_C_COMPILER:-clang-17}
CMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER:-clang++-17}
...
cmake \
    ...
    -DCMAKE_C_FLAGS="$CMAKE_C_FLAGS -ld64" \
    -DCMAKE_CXX_FLAGS="$CMAKE_CXX_FLAGS -ld64" \
