...
shouldBe("result", '"LayoutTests/js/script-tests/exception-line-number.js:6,LayoutTests/js/script-tests/exception-line-number.js:11"');
...
window.onerror = function(msg, url, line) {
    ...
    result = url + ':' + line;
    shouldBe("result", '"LayoutTests/js/script-tests/exception-line-number.js:36"');
