...
(function() {
    ...
    ["media-controls", "scrubber", "volume-slider", "slider", "button", "start-button", "icon-button", "airplay-button", "time-label", "macos-inline-media-controls", "buttons-container", "placard"].forEach(cssFile => {
