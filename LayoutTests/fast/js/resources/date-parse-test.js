...
function testDateParseExpr(dateExpr, numericResult)
{
    if (isNaN(numericResult)) {
        ...
        shouldBe('Date.parse(' + dateExpr + ')', numericResult.toString());
        shouldBe('Date.parse((' + dateExpr + ').toUpperCase())', numericResult.toString());
        shouldBe('Date.parse((' + dateExpr + ').toLowerCase())', numericResult.toString());
    }
}
