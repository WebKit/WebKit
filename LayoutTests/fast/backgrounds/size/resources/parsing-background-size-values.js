...
shouldBe('test("background-size: auto coconut;")', '""');
shouldBe('test("-webkit-background-size: 10px coconut;")', '""');
shouldBe('test("-webkit-background-size: auto coconut;")', '""');
shouldBe('test("background-size: 50% coconut, 2em;")', '""');
shouldBe('test("-webkit-background-size: 50% coconut, 2em;")', '""');
...
shouldBe('test("background-size: 50% 100px, 2em, 100px 50%;")', '"50% 100px, 2em auto, 100px 50%"');
