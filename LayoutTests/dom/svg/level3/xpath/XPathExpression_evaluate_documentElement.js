...
{
return ['XPathExpression_evaluate_documentElement'];
}
...
*/
function XPathExpression_evaluate_documentElement() {
   var success;
    if(checkInitialization(builder, "XPathExpression_evaluate_documentElement") != null) return;
    var doc;
      var xpEvaluator;
...
function runTest() {
   XPathExpression_evaluate_documentElement();
}
