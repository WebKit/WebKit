...
{
return ['XPathResult_snapshotItem_UNORDERED_NODE_SNAPSHOT_TYPE_null'];
}
...
*/
function XPathResult_snapshotItem_UNORDERED_NODE_SNAPSHOT_TYPE_null() {
   var success;
    if(checkInitialization(builder, "XPathResult_snapshotItem_UNORDERED_NODE_SNAPSHOT_TYPE_null") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
...
function runTest() {
   XPathResult_snapshotItem_UNORDERED_NODE_SNAPSHOT_TYPE_null();
}
