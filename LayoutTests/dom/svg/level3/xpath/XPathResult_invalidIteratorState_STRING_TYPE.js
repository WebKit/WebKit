...
{
return ['XPathResult_invalidIteratorState_STRING_TYPE'];
}
...
*/
function XPathResult_invalidIteratorState_STRING_TYPE() {
   var success;
    if(checkInitialization(builder, "XPathResult_invalidIteratorState_STRING_TYPE") != null) return;
    var ANY_TYPE = 0;
      var NUMBER_TYPE = 1;
      var STRING_TYPE = 2;
      var BOOLEAN_TYPE = 3;
...
function runTest() {
   XPathResult_invalidIteratorState_STRING_TYPE();
}
