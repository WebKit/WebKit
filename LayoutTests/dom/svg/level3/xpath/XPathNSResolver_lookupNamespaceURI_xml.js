...
{
return ['XPathNSResolver_lookupNamespaceURI_xml'];
}
...
*/
function XPathNSResolver_lookupNamespaceURI_xml() {
   var success;
    if(checkInitialization(builder, "XPathNSResolver_lookupNamespaceURI_xml") != null) return;
    var doc;
      var resolver;
      var evaluator;
      var element;
...
for(var indexN65631 = 0;indexN65631 < elements.length; indexN65631++) {
      ...
      lookupNamespaceURI = resolver.lookupNamespaceURI("xml");
      assertEquals("equal","http://www.w3.org/XML/1998/namespace",lookupNamespaceURI);
