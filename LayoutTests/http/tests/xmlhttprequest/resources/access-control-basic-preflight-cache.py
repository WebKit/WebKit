...
if state == 'Uninitialized':
    ...
    if os.environ.get('REQUEST_METHOD') == 'PUT':
    ...
    elif os.environ.get('REQUEST_METHOD') == 'OPTIONS':
        sys.stdout.write(
            'Access-Control-Allow-Origin: http://127.0.0.1:8000\r\n'
            'Access-Control-Allow-Credentials: true\r\n'
            'Access-Control-Allow-Methods: PUT\r\n'
        ...
        setState('FAILSecondOPTIONSSent', stateFile)
    else:
        fail()
    ...
    if os.environ.get('REQUEST_METHOD') == 'PUT':
        sys.stdout.write(
            ...
            'Access-Control-Allow-Credentials: true\r\n'
            '\r\n')
        sys.stdout.write('FAIL: Second OPTIONS request was sent.  Preflight failed')
    else:
        fail()
