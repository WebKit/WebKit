...
static constexpr bool FLAGS_direct = false; // "run direct measurement");
static constexpr int32_t FLAGS_reps = 10; // "number of reps");
static constexpr int32_t FLAGS_ops = 100000; // "number of operations per rep");
static constexpr int32_t FLAGS_lines = 5; // "number of cache lines accessed per operation");
static constexpr int32_t FLAGS_numRecs = 8; // "number of records");
static constexpr int32_t FLAGS_work = 1000; // "amount of unrelated work per operation");
